<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bamboo.aspx.cs" Inherits="bamboo" %>
...
<head>
    ...
    <title>HY RETURN OF BAMBOO</title>
...
<h2 class="end"> Half Yearly progress report on Bamboo Coupe for the year-2023-24 of BLACK TIGER </h2>
    ...
    <table class="table table-bordered table-hover">
      ...
      <thead>
        <tr>
            ...
            <th rowspan="3">Name of Division </th>
            <th rowspan="3">No of Coupe due for working</th>
            <th rowspan="3">Area (in Ha.)</th>
            <th rowspan="3">No. of coupe delivered to OFDC Ltd.</th>
            <th rowspan="3">Area (in Ha.)</th>
            <th rowspan="3">Name of the coupe surrendered by OFDC Ltd.</th>
            <th rowspan="3">Area (in Ha.)</th>
            <th rowspan="3">Reason Surrender if any</th>
            <th rowspan="3">Name of the Coupe</th>
            <th rowspan="3">Area (in Ha.)</th>

            <th colspan="4">Production of bamboo during the month</th>
            <th colspan="4">Production of Bamboo-Progressive Total</th>
            <th colspan="4">Mandays Generated</th>
            <th colspan="4">Qty. transported/lifted from Forest floor During the month</th>
            <th colspan="4">Qty. transported/lifted from Forest floor Progressive total</th>
            <th colspan="4">Balance at Forest</th>
        </tr>

        <tr>
            <th colspan="2">IB in SU</th>
            <th colspan="2">CB in SU</th>
            <th colspan="2">IB in SU</th>
            <th colspan="2">CB in SU</th>
