...
public partial class acusedfrwding : System.Web.UI.Page
{
    ...
    public static string Insert(List<accusedData> jsonDynmxcxx)
    {
    ...
    public static List<accusedData> GetAutoCompleteData(string prefix)
    {
        List<accusedData> services = new List<accusedData>();
