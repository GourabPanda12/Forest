<%@ Page Language="C#" AutoEventWireup="true" CodeFile="leaslnk.aspx.cs" Inherits="leaslnk" %>
...
<body>
    ...
    <div class="container" style="margin-top:50px;">
        <div class="row" id="paneldiv">
            <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                <a href="forwld.aspx" class="card-link">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center">HY RETURN OF BAMBOO</h5>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                <a href="offline.aspx" class="card-link">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center">HY RETURN OF TIMBER</h5>
                            <p class="card-text text-center">Black Tiger</p>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                 <a href="legal.aspx" class="card-link">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center">HY REPORT ON DEMAND, COLLECTION & BALANCE</h5>
                            <p class="card-text text-center">Black Tiger</p>
                        </div>
                    </div>
                </a>
           ...
           <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                <a href="pblcgrvnce.aspx" class="card-link">
                    <div class="card">
                        <span><i class="fa fa-rocket treex" aria-hidden="true"></i></span>
                        <div class="card-body">
                            <h5 class="card-title text-center">DISPOSAL OF CERTIFICATE CASES</h5>
                            <p class="card-text text-center">Black Tiger</p>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                <a href="judgement.aspx" class="card-link">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center">HY REPORT ON SALVAGE OPERATION</h5>
                            <p class="card-text text-center">Black Tiger</p>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                <a href="act.aspx" class="card-link">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center">HY RECORDED HOLDING REPORT</h5>
                            <p class="card-text text-center">Black Tiger</p>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                <a href="Userroles.aspx" class="card-link">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title text-center">RTI</h5>
                            <p class="card-text text-center">Black Tiger</p>
                        </div>
                    </div>
                </a>
