<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Offencepdf.aspx.cs" Inherits="Offencepdf" %>
        ...
        $(document).ready(function () {
            ...
            function generatePDF(data) {
                ...
                img.onload = function () {
                    ...
                    doc.addImage(img, 'PNG', 60, 1, 160,50); // (image, format, x, y, width, height)
                    ...
                    textArray.forEach(function (sentence) {
                     if (inc == 1) {
                         doc.text(200, 20, sentence);
                                doc.setFont("helvetica", "bold");
                                y += 10;
                            }
                            if (inc == 2) {
                                doc.text(70, 35, sentence);
                                doc.setFont("helvetica", "bold");
                                y += 10;
                            }
                            if (inc == 3) {
                                doc.text(74, 42, sentence);
                                doc.setFont("helvetica", "bold");
                                y += 10;
                            }
                    ...
                    img2.onload = function () {
                        ...
                        doc.addImage(img2, 'PNG', 5, 65, 270, 120); // Adjust position as needed
                     ...
                     var erx = 1;
                        textArray2.forEach(function (sentence) {
                            if (erx == 1) {
                                doc.text(97, 75, sentence);
                                doc.setFont("helvetica", "bold");
                                y += 10;
                            }
                          erx++
                                //doc.text(185, 51, sentence);
                                //doc.setFont("helvetica", "bold");
                                //y += 10;
                            ...
                            //inc++; // Increment y position for the next sentence
                        });
                    ...
                    img2.src = 'pdfimages/Offence1.jpg';




                };
                img.src = 'pdfimages/FORM-V-COMPOUNDING-RECEIPT_Header.jpg';
