<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pending-trial.aspx.cs" Inherits="pending_trial" %>
...
<head>
    ...
    <title>QUATERLY PROGRESS REPORT OF WILDLIFE CASES PENDING TRIAL </title>
...
<h2 class="end1" style="margin-bottom: 20px;">QUARTERLY PROGRESS REPORT ON IMPOTANT WILDLIFE CASES PENDING TRIAL IN COURTS FOR QUARTER ENDING
    DECEMBER-2023 OF BLACK TIGER.(FORM;D-VII )
    </h2>
        ...
        <table class="table table-bordered table-hover">
            ...
            <thead>
                <tr>
                    ...
                    <th>Name of the court Case No.</th>
                    ...
                    <tbody>
                        <tr>
                            <td>17.10.2023
                                OR.62 of 2023-24 of Padiabahal Range
                            </td>
                            <td>Forest Deptt</td>
                            <td>After getting concrete& reliable information a search operation was made in Kulcher Reserve Forest area by the Range Staff of Padiabahal on dtd.17.10.2023. At about 7.30 AM forest staff apprehended the accused person moving inside the Reserve Forest with a loaded country made gun.</td>
                            <td>One Country made loaded  Gun, 
                                7 Nos. of handmade lead pellet , 
                                 Gun Powder 30 grams, 
                                 Small lead gun pellet- 30, grams 
                                 Roll cap gun powder -6 Pkt, 
                                 Coconut husk- 20 grams(approx) 
                                Niddle with bamboo top- 1 no. (small) 
                            </td>
                            <td>Sanjay Mirdha
                                S/o- Jugindra Mirdha 
                                 Village- Hiro (Chilkampada)
                                 Po-Dangarpada, Ps- Iujomura, Dist.- Sambalpur </td>
                            <td>18.10.2023</td>
                            <td>S.D.J.M.,
                                Sambalpur. 2(b)CC No.05/2023</td>
    ...
    <div style="float: right; padding-top: 10px;" class="re fg">
    ...
    <div style="margin-top: 60px;" class="text-center">
        ...
        <h2 class="end1">QUARTERLY PROGRESS REPORT ON (Form-D-X)</h2>
            <p class="end1">HUMAN BEING KILLED BY ELEPHANT AND DEATH OF ELEPHANT</p>

                <p class="end1">Name of the Division :- BLACK TIGER</p>

                    <p class="end1">Name of the Circle:-SAMBALPURCIRCLE</p>
                        <p class="end1">Quarter Ending-DECEMBER-2023</p>
        ...
        <table class="table table-bordered table-hover">
            ...
            <thead>
                <tr>
                    ...
                    <th colspan="5">Detail of human being killed by elephant</th>
                    <th colspan="8">Detail of death of elephant</th>
