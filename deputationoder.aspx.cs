...
public partial class deputationoder : System.Web.UI.Page
{
    ...
    public static string Insert(List<DepuData> jsonDynmxcxx)
    {
    ...
    public static List<DepuData> GetAutoCompleteData(string prefix)
    {
        List<DepuData> services = new List<DepuData>();
