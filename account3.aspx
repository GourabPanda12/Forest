<%@ Page Language="C#" AutoEventWireup="true" CodeFile="account3.aspx.cs" Inherits="account3" %>
...
<head>
    ...
    <title>QUATERLY PROGRESS REPORT (NBM)</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-11 col-sm-10 col-md-10 col-lg-11 col-xl-11 text-center p-0 mt-3 mb-2">
                        <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                            ...
                            <h2 class="end" style="margin-top: 20px;">Physical and Financial Quarterly Progress Report of National Bamboo Mission (NBM) </h2>
    ...
    <table class="table table-bordered table-hover">
        ...
        <thead>
            <tr>
                ...
                <th rowspan="2">Name of the Components (AAP year wise) </th>
                <th colspan="2">Limitation Fixed/ Allotment 
                </th>


                <th colspan="2">Limitation Fixed upto Previous

                </th>
                <th colspan="2">Now Limitation Fixed</th>
                <th colspan="2">Total Limitation Fixed upto</th>

                <th colspan="2">Expenditure upto Previous Quarter</th>
                <th colspan="2">Expenditure During the Quarter</th>
                <th colspan="2">Expenditure upto end of the Quarter</th>
            ...
            <tr>
                <th>Physical in Ha.</th>
                <th>Financial in Rs.</th>
                <th>Physical</th>
                <th>Financial</th>
                <th>Physical</th>
                <th>Financial</th>
