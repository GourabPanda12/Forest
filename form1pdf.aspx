<%@ Page Language="C#" AutoEventWireup="true" CodeFile="form1pdf.aspx.cs" Inherits="form1pdf" %>
    ...
    <script>
        $(document).ready(function () {
            $("#btnGeneratePDF").click(function (event) {
                ...
                $.ajax({
                    type: "POST",
                    url: "GetData.asmx/GetDatabaseData",
            ...
            function generatePDF(data) {
                ...
                img.onload = function () {
                    ...
                    doc.addImage(img, 'PNG', 10, 10, 200, 200); // (image, format, x, y, width, height)
