<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Offence-cases-booked.aspx.cs" Inherits="Offence_cases_booked" %>
...
<head>
    ...
    <title>Offence CASES BOOKED UNDER WILDLIFE PROTECTION ACT,1972</title>
...
<h2 class="end"> Status of Offence Cases booked under Wildlife (Protection) Act, 1972 during 2003-04 to 2022-23</h2>
    ...
    <table class="table table-bordered table-hover">
        ...
        <thead>
            <tr>
                ...
                <th  rowspan=2>Case No. & date with Penal Section</th>
                <th  rowspan=2>Date of detection</th>
                <th  rowspan=2>Place of detection(Mention Name of  FB or Revenue forest or other land)</th>
                <th  rowspan=2>GPS location</th>
                <th  rowspan=2>Case detecting agency  (Forest or other agency name)</th>
                <th  rowspan=2>Case investigating agency (Forest or other agency name)</th>

                <th  rowspan=2>Name of the Species involved </th>
                <th  rowspan=2>Age & Sex of species</th>
                <th  rowspan=2>Schedule of the Species under WLPA</th>
                <th  rowspan=2>Property recovered (live animal / carcass / body parts / arms and ammunition / GI wire / vehicles / other material etc.)</th>
                <th  rowspan=2>Brief fact of the case </th>
                <th  rowspan=2>Name and mobile No. of IO of the Case</th>
                <th  colspan=5>Accused details </th>
                <th  rowspan=2>Name of the accused arrested</th>
                <th  rowspan=2>Date of forwarding to Court</th>
                <th  rowspan=2>Name of the accused against whom NBW issued & status of NBW execution</th>
                <th  rowspan=2>Court name & Case (2bcc) No.</th>
                <th  rowspan=2>Name of the accused released on bail with date</th>
                <th  rowspan=2>Status of submission of Final PR</th>
                <th  rowspan=2>Action taken against any staff (Departmental staff)</th>
                <th  rowspan=2>Present status of the case (Under trial/convicted/aquital)</th>
                </tr>



                <tr>
                 <th>Name of the accused persons</th>
                 <th>Alias</th>
                 <th>Fathers Name</th>
                 <th>address of the accused person</th>
                 <th>Mobile Number, IMEI (all SIM) of the phone seized</th>
                </tr>
                </thead>
