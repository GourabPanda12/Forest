﻿<%@ Page Language="C#" AutoEventWireup="true" CodeFile="compoundorder.aspx.cs" Inherits="compoundorder" %>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(".add23").click(function () {
                ...
                var inputValue = $("#txtszre").val().trim();
                // Check if the input value is not empty
                if (inputValue !== "") {
                    var isDuplicate = false;
                    // Check if the value already exists in the list
                    $("#szureDetail p").each(function () {
                        if ($(this).text().indexOf(inputValue) !== -1) {
                            isDuplicate = true;
                            return false; // Exit the loop early if duplicate found
                        }
                    });
                    // If it's not a duplicate, append the value to the list
                    if (!isDuplicate) {
                        var newParagraph = $("<p>").text("Seizure Detail: " + inputValue);
                        ...
                        $("#szureDetail").append(newParagraph);
                        // Clear the input field
                        $("#txtszre").val("");
                    } else {
                        // Alert the user that the value already exists
        ...
        function sub() {
            ...
            var offncfno = $("#txtflno").val();
            var shri = $("#txtacsd").val();
            var ttlsum = $("#txtsum").val();
            var sumwrds = $("#txtwrd").val();
            var sectn = $("#txtsec").val();
            var szrdtl = $("#txtszre").val();
            var athrfo = $("#txtfo").val();
            var designation = $("#txtdesig").val();
            var place = $("#txtplce").val();
            var dated = $("#txtdt").val();
            var mrdd = $("#txtmr").val();
            var offclrmge = $("#txtofrnge").val();
            var formino = $("#txtformino").val();
            var fdeptmt = $("#txtfdpt").val();
            var divisn = $("#txtdvsn").val();
            var formi = $("#txtfrmino").val();
            var formii = $("#txtfrmiino").val();
            var under = $("#txtofncund").val();
            var acsnm = $("#txtacs").val();
            var rsum = $("#txtlsum").val();
            var suminwords = $("#txtswrds").val();
            var rsncamnt = $("#txtrsn").val();
            var formiino = $("#txtreformiino").val();
            var places = $("#txtplace").val();
            var dte = $("#txtdte").val();
            var tme = $("#txtme").val();
            var ofcr = $("#txto").val();
            var rngofcrnm = $("#txtrnge").val();

            var fdepartmentlist = [];
            // Create and push user object to users array
            fdepartmentlist.push({
                offncfno: offncfno,
                shri: shri,
                ttlsum: ttlsum,
                sumwrds: sumwrds,
            ...
            $.ajax({
                type: "POST",
                url: "compoundorder.aspx/Insert",
                data: "{fdepartmentlist:" + JSON.stringify(fdepartmentlist) + "}",
...
#szureDetail input[type="text"].to34  {
 ...
 <form id="form1" runat="server">
  ...
  <aside id="sidebar">
   ...
   <!-- SIDEBAR -->
              ...
              <div class="col-11 col-sm-10 col-md-10 col-lg-11 col-xl-11 text-center p-0 mt-3 mb-2">
                <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                  <div class="text-center">
                    ...
                    <p id="heading1">FORM VI </p>

                    <p id="heading1">[Vide Rule 7]</p>



                    <p id="heading1">COMPOUNDING ORDER</p>
                          ...
                          <div class="form-card">
                            ...
                            <div class="row ">
                              <div class="col-md-10  col-12 mx- auto offset-md-1">
                                ...
                                <div class="login-form">
                                  ...
                                  <div class="row asd d-flex">
                                    <div class="col-lg-12  col-sm-12 col-xs-12 abc1"> <br>
                                      <p class="to34">Forest Offence File No.<input type="text" id="txtflno" class="inp" placeholder=""></p>
                                      <p class="to34">
                                        In view of the compounding petition filed by the accused Shri <input type="text" id="txtacsd"
                                          class="inp" placeholder="">
                                        I hereby order in exercise of the powers conferred under Section 72 of the Odisha Forest
                                        Act, 1972 that a sum of Rs.<input type="number" id="txtsum" class="inp" placeholder="">(in
                                        words and figures) <input type="text" id="txtwrd" class="inp" placeholder=""> be paid towards
                                        compensation by the accused for the forest Offence committed by him under Section.
                                        <input type="text" id="txtsec" class="inp" placeholder=""> of the said Act.
                                      </p>
        
                                      <p class="to34"> 2. &nbsp  On Payment of the compensation amount in
                                        full, the seizures detailed hereunder shall be released the seized forest produce
                                        detailed hereunder shall be forfeited to the State.</p>
        
                                      <h5 style="text-align: center; font-size: 16px; font-weight: 600;" class="to34"> DETAILS OF SEIZURE
                                      </h5>
        
                                      
                                       <p class="to34"> 1. <input type="text" id="txtszre" class="inp" placeholder=""></p>
                             ...
                             <button class="bt11 add23" type="button" ><i class="fa fa-plus" aria-hidden="true"></i></button>
                                     ...
                                     <div id="szureDetail">  </div>
                                      
                                      
                                      <div class="to34"> etc.</div><br>
        
                                      <p class="to34"> 3. &nbsp  If the compensation is not paid in full
                                        within thirty days from the date of issue of this order, acting to recover the same, if
                                        necessary, shall be taken as per provisions of Section 87 of the aforesaid Act.</p><br>
        
                                      <div class="row  d-flex">
                                        <div class="col-lg-6  col-sm-6 col-xs-6 abc1">
                                        </div>
                                        <div class="col-lg-6  col-sm-6 col-xs-6 abc1">
                                          <p class="to34">Authorized Forest Officer <input type="text" id="txtfo" class="inp" placeholder=""></p>
                                        </div>
                                      </div><br>
                                      ...
                                      <div class="row  d-flex">
                                        ...
                                        <div class="col-lg-6  col-sm-6 col-xs-6 abc1">
                                          <p class="to34"> Designation <input type="text" id="txtdesig" class="inp" placeholder=""></p>
                                        </div>
                                      </div><br><br>
                                      <p class="to34"> Place <input type="text" id="txtplce"
                                          class="inp" placeholder=""></p>
                                      <p class="to34"> Dated <input type="date" id="txtdt"
                                          class="inp" placeholder=""></p><br>
        
                                      <p class="to34">  To, </p>
                                      <p class="to34"> &nbsp &nbsp Shri
                                        <input type="text" id="txtmr" class="inp" placeholder=""></p>
        
                                      <p class="to34">
                                        Copy to the range Officer Range <input type="text" id="txtofrnge" class="inp" placeholder="">He
                                        is requested to take further actions as per rules. A spare copy of the order enclosed,
                                        may be handed over to the accused and the due acknowledgement obtained.
                                      </p>
        
                                      <p style="text-align: center;" class="to34"> Note - Sentences/words not applicable be stuck off.</p>
                    ...
                    <input type="text" id="txtformino"  class="form-control console" placeholder="">	
											</div>
											 <div class="col-lg-4  col-sm-4 col-xs-4 abc">		
                             <label class="lebl">Forest Department  </label>
                    <input type="text" id="txtfdpt"  class="form-control console" placeholder="">	
											</div>
											 <div class="col-lg-4  col-sm-4 col-xs-4 abc">
    ...
    <input type="text" id="txtfrmino"  class="form-control console" placeholder="">	
									</div>
									 <div class="col-lg-6  col-sm-6 col-xs-6 abc">
										 <label class="lebl">Form -II </label>
    <input type="text" id="txtfrmiino"  class="form-control console" placeholder="">	
									</div>
										</div>
										<br>
                                      ...
                                      <p style="text-align: center; margin-top: 25px;" class="to34">Form-I NO. <input type="number" id="txtformino"
                                          class="inp" placeholder=""></p>
                                      <p style="text-align: center;" class="to34">FOREST DEPARTMENT <input type="text" id="txtfdpt" class="inp"
                                          placeholder=""></p>
                                      <p style="text-align: center;" class="to34">DIVISION <input type="text" id="txtdvsn" class="inp"
                                          placeholder=""></p><br>
                                      <p class="to34">Reference:</p>
                                      <p class="to34">Form -I <input type="text" id="txtfrmino" class="inp" placeholder=""></p>
                                      <p class="to34">Form -II <input type="text" id="txtfrmiino" class="inp" placeholder=""></p><br>
										-->



        
                                      <P class="to34"> In view of the violation of Offences under <input type="text" id="txtofncund" class="inp"
                                          placeholder="">, the compounding petition filed by the accused <input type="text"
                                          id="txtacs" class="inp" placeholder="">. I hereby order in exercise of the powers conferred
                                        under Section 72 of the Odisha Forest Act 1972/ Section – 54 of Wildlife Protection Act
                                        1972 that a sum of Rs.<input type="number" id="txtlsum" class="inp" placeholder=""><input
                                          type="text" id="txtswrds" class="inp" placeholder=""> (in words and figures) towards
                                        compensation.
                                      </P><br>
        
                                      <p class="to34">Reasons for determination of such compensation amount <input type="text" id="txtrsn"
                                          class="inp" placeholder=""></p><br>
                                      <p class="to34">A bond supported with sureties against the condition that he/she will not involve
                                        herself/ himself in commission of wildlife or forest Offence in near future shall also
                                        be submitted by the accused.</p>
        
                                      <p class="to34">On payment of the compensation amount in full, the seizures detailed hereunder shall be
                                        released (Ref. Form – II No <input type="number" id="txtreformiino" class="inp" placeholder="">) and
                                        the seized forest produce detailed hereunder shall be forfeited to the State. The list
                                        in brief as follows:</p>
        
                                      <p class="to34">If the compensation and directions in the order is not complied within thirty days from
                                        ‘the date of issue of this order’, the amount shall be recovered following the necessary
                                        provisions in Odisha Forest Act 1972 and Wildlife Protection Act 1972.</p>
        
                                      <p class="to34">On non-submission of bond, his/her release and discharge shall subject to discretion of
                                        the authorised forest officer upon some other conditions deemed fit in this regard.</p>
        
        
                                      <div class="row  d-flex">
                                        <div class="col-lg-8  col-sm-8 col-xs-8 abc1">
                                          <div class="to34">Place <input type="text" id="txtplace" class="inp" placeholder="">
                                            <span>Date<input type="date" id="txtdte" class="inp" placeholder="">&nbsp;</span><p>Time <input type="time" id="txtme" class="inp" placeholder=""></p>
                                          </div>
                                        </div>
                                        <div class="col-lg-4  col-sm-4 col-xs-4 abc1">
                                          <p style="float: right;">Authorised Forest Officer</p>
                                        </div>
                                      </div><br>
        
                                      <p class="to34">To <input type="text" id="txto" class="inp" placeholder=""></p>
                                      <p class="to34">Copy to the Range Officer of <input type="text" id="txtrnge" class="inp" placeholder=""></p>
                                      <p class="to34">He is requested to take further actions as per rules.</p>
                                      <p class="to34" style="font-weight: 600; font-size: 16px;">N.B: Strike - off whichever is not
                                        applicable.</p>
        
                                      <p class="to34">Received By (with Name and signature mentioning date and time) <input type="file" id=""
                                          class="inp" placeholder=""></p>
                        ...
                        <div class="login-form">
                          ...
                          <div class="col-lg-4  col-sm-4 col-xs-4 abc">
                           ...
                           <div class="col-lg-4  col-sm-4 col-xs-4 abc">
                            ...
                            <button class="btny mt-4" type="button" onclick="window.location.href='compoundorderpdf.aspx'">Download Pdf</button>
