<%@ Page Language="C#" AutoEventWireup="true" CodeFile="chemicalexrepo.aspx.cs" Inherits="chemicalexrepo" %>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"
 ...
 <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.5.14/jspdf.plugin.autotable.min.js"></script>
	...
	<title>Chemical Examination Report</title>
    <script type="text/javascript">
        ...
        function print() {
           ...
           // doc.addImage(imgData, 'PNG', logoX, margin, logoWidth, logoHeight); // Position and size of the logo
            ...
            doc.text("Chemical Examiation Report", pdfWidth / 2, topMargin + 25, { align: "center" });
            ...
            doc.save('case-document-chemicalexrepo.pdf');
...
<h2 class="text-center" style="color: #fff;">Chemical Examination Report</h2>
  ...
  <div class="row asd d-flex">
                                          ...
                                          <div class="col-lg-6  col-sm- col-xs-6 abc">
