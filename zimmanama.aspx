<%@ Page Language="C#" AutoEventWireup="true" CodeFile="zimmanama.aspx.cs" Inherits="zimmanama" %>
        ...
        function print() {
         ...
         //   doc.addImage(imgData, 'PNG', logoX, margin, logoWidth, logoHeight); // Position and size of the logo
          ...
          //  doc.text('Phone: (123) 456-7890', pageWidth / 2, margin + 95, { align: 'center' });
            ...
            doc.text("Zimmanamma", pdfWidth / 2, topMargin + 15, { align: "center" });
...
<h2 class="text-center" style="color: #fff;">Zimanamma</h2>
