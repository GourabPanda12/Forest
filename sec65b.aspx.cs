...
public partial class sec65b : System.Web.UI.Page
{
    ...
    public static string Insert(List<sec65bData> jsonDynmxcxx)
    {
    ...
    public static List<sec65bData> GetAutoCompleteData(string prefix)
    {
        List<sec65bData> services = new List<sec65bData>();
