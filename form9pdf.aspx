<%@ Page Language="C#" AutoEventWireup="true" CodeFile="form9pdf.aspx.cs" Inherits="form9pdf" %>
        ...
        $(document).ready(function () {
            ...
            function generatePDF(data) {
                ...
                img.onload = function () {
                    ...
                    doc.addImage(img, 'PNG', 50, 1, 200, 40); // (image, format, x, y, width, height)
                    ...
                    img2.onload = function () {
                        ...
                        doc.addImage(img2, 'PNG', 30, 45, 200, 25); // Adjust position as needed
                        ...
                        textArray2.forEach(function (sentence) {
                            if (cf == 1) {
                                doc.text(70, 50, sentence);
                                doc.setFont("helvetica", "bold");
                                y += 10;
                            }
                            if (cf == 2) {
                                doc.text(180, 50, sentence);
                                doc.setFont("helvetica", "bold");
                                y += 10;
                            }
                            if (cf == 3) {
                                doc.text(70, 58, sentence);
                                doc.setFont("helvetica", "bold");
                                y += 10;
                            }
                            if (cf == 4) {
                                doc.text(180, 58, sentence);
                                doc.setFont("helvetica", "bold");
                                y += 10;
                            }
                            if (cf == 5) {
                                doc.text(90, 65, sentence);
                                doc.setFont("helvetica", "bold");
                                y += 10;
                            }
                            cf++; // Increment y position for the next sentence
                        });

                        // Save the PDF after both images and associated text have been added
                        var tableData = [
                            ["Date", "Time", "Description"],
                            ["2024-04-12", "12:00 PM", "Description 1"],
                            ["2024-04-13", "01:00 PM", "Description 2"],
                            ["2024-04-14", "02:00 PM", "Description 3"]
                        ];
                        doc.autoTable({
                            startY: yPosition2 + 50, // Start the table below the text
                            head: [tableData[0]],
                    ...
                    img2.src = 'pdfimages/casediary1.jpg';




                };
                img.src = 'pdfimages/casedry.jpg';
