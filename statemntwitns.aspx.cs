...
public partial class statemntwitns : System.Web.UI.Page
{
    ...
    public static string Insert(List<stmntData> jsonDynmxcxx)
    {
    ...
    public static List<stmntData> GetAutoCompleteData(string prefix)
    {
        List<stmntData> services = new List<stmntData>();
