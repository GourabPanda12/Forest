<%@ Page Language="C#" AutoEventWireup="true" CodeFile="scst41an.aspx.cs" Inherits="scst41an" %>
    ...
    <script type="text/javascript">
        ...
        function print() {
         ...
         //   doc.text('Phone: (123) 456-7890', pageWidth / 2, margin + 95, { align: 'center' });
            ...
            doc.text("Section 41a notice to accused", pdfWidth / 2, topMargin + 15, { align: "center" });
...
<h2 class="text-center" style="color: #fff;">Section 41a notice to accused</h2>
