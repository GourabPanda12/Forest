...
<%@ Page Language="C#" AutoEventWireup="true" CodeFile="acusedfrwding.aspx.cs" Inherits="acusedfrwding" %>
 ...
 <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.5.14/jspdf.plugin.autotable.min.js"></script>
    ...
    <script type="text/javascript">
     ...
     //       doc.text('Phone: (123) 456-7890', pageWidth / 2, margin + 95, { align: 'center' });
            ...
            doc.text("Accused Forwarding", pdfWidth / 2, topMargin + 25, { align: "center" });
            ...
            doc.save('case-document-acusedfrwding.pdf');
              ...
              <ul>
                 ...
                 <li><a href="deputationoder.aspx">Deputation order of witnesses by concerned authority</a></li>
                  ...
                  <li><a href="aftersearch.aspx">After search protocol</a></li>
                   ...
                   <li><a href="fircopy.aspx">Accused Forwarding</a></li>
...
<h2 class="text-center" style="color: #fff;">Accused Forwarding</h2>
