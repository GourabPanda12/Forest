<%@ Page Language="C#" AutoEventWireup="true" CodeFile="witnesspdf.aspx.cs" Inherits="witnesspdf" %>
        ...
        $(document).ready(function () {
            ...
            function generatePDF(data) {
                ...
                img.onload = function () {
                    ...
                    doc.addImage(img, 'PNG', 80, 1, 160, 70); // (image, format, x, y, width, height)
                    ...
                    img2.onload = function () {
                        ...
                        doc.addImage(img2, 'PNG', 1, 10, 290, 240); // Adjust position as needed
                        ...
                        img3.onload = function () {
                            ...
                            doc.addImage(img3, 'PNG', 1, 10, 290, 240); // Adjust position as needed
                        ...
                        img3.src = 'pdfimages/wtns2.jpg';
                    };

                    img2.src = 'pdfimages/wtns1.jpg';




                };
                img.src = 'pdfimages/attndcewtns.jpg';
