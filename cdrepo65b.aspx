﻿<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cdrepo65b.aspx.cs" Inherits="cdrepo65b" %>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"
 ...
 <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.5.14/jspdf.plugin.autotable.min.js"></script>
	...
	<title>CDR report along with U/s 63(4) of Bhartiya Sakshya Adhiniyam, 2023 certificate by concerned Nodal officer through Superintendent of Police concerned</title>
    ...
    <script type="text/javascript">
        ...
        function print() {
            ...
            doc.text("CDR report along with U/s 63(4) of Bhartiya Sakshya\n" +
               " Adhiniyam, 2023 certificate by concerned\n" +
                " Nodal officer through Superintendent of Police concerned", pdfWidth / 2, topMargin + 28, { align: "center" });

            // Set initial y position below the gradient header
            let yPosition = topMargin + gradientHeight + 33;
            doc.setFontSize(12);

            rqtn.forEach(item => {
                // Center "Document Uploaded" Text
                doc.setTextColor(0, 0, 0);
                doc.text(`Document Uploaded: ${item.caseno}`, pdfWidth / 2, yPosition+5, { align: "center" });
            ...
            doc.save('case-document-cdrepo65b.pdf');
              ...
              <ul>
                 ...
                 <li><a href="deputationoder.aspx">Deputation order of witnesses by concerned authority</a></li>
                  ...
                  <li><a href="aftersearch.aspx">After search protocol</a></li>
                   ...
                   <li><a href="fircopy.aspx">CDR report along with 65 B certificate by concerned Nodal officer through Superintendent of Police concerned</a></li>
...
<h2 class="text-center" style="color: #fff;">CDR report along with U/s 63(4) of Bhartiya Sakshya Adhiniyam, 2023 certificate by concerned Nodal officer through Superintendent of Police concerned</h2>
