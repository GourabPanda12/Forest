<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default88.aspx.cs" Inherits="Default88" %>
    ...
    <script type="text/javascript">
        ...
        function print() {
         ...
         //   doc.text('Phone: (123) 456-7890', pageWidth / 2, margin + 95, { align: 'center' });
            ...
            doc.text("Requistion for forensic examination for identification of species", pdfWidth / 2, topMargin + 15, { align: "center" });
...
<h2 class="text-center" style="color: #fff;">Requistion for forensic examination for identification of species</h2>
