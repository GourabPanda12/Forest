...
public partial class dforprt : System.Web.UI.Page
{
    ...
    public static string Insert(List<dforpData> jsonDynmxcxx)
    {
    ...
    public static List<dforpData> GetAutoCompleteData(string prefix)
    {
        List<dforpData> services = new List<dforpData>();
