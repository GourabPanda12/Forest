<%@ Page Language="C#" AutoEventWireup="true" CodeFile="calldtlsrecord.aspx.cs" Inherits="calldtlsrecord" %>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"
	...
	<title>Call Details Record</title>
...
<body>
	...
	<main>
         ...
         <div class="container" style="margin-top: 80px;">
            ...
            <h3 class="text-center" style="color: #fff;">ANNEXURE – 12 </h3>
            <h2 class="text-center" style="color: #fff;">FOREST DEPARTMENT, ODISHA </h2>
            <h2 class="text-center" style="color: #fff;">PROFORMA FOR SEEKING CALL DATA RECORDS </h2>
...
<input type="text" id="txtfir" class="form-control console" placeholder="">
                 ...
                 <div class="form-group form-section">
                     <label for="facts">Facts in brief satisfying the call for records: Ref. Form- I</label>
                     ...
                     <table class="mobile-details">
                         <thead>
                             <tr>
                                 ...
                                 <th>Phone Number</th>
                                 <th>IMEI</th>
                                 <th>Nature of connection (GSM/CDMA)</th>
                                 <th>Service Provider</th>
                                 <th>Details required for the period</th>
                             </tr>
                         </thead>
                         <tbody>
                             <tr>
                 ...
                 <div class="form-group form-section ">
                     <label for="callData">Particulars of Call Data Records required:</label>
                     <textarea class="form-control" id="callData" rows="3" placeholder=""></textarea>
                 </div>
                 <div class="form-group form-section">
                     <label for="requestingOfficer">Requesting Range Officer</label>
                     <input type="text" class="form-control" id="requestingOfficer" placeholder="">
                 </div>
                 <div class="form-group form-section">
                     <label for="dateTimeRequest">Date:</label>
                     <input type="text" class="form-control" id="dateTimeRequest" placeholder="">
                 </div>
                 <div class="form-group form-section">
                    <label for="dateTimeRequest">Time:</label>
                    <input type="text" class="form-control" id="dateTimeRequest" placeholder="">
                </div>

                 
                 <div class="form-group form-section">
                     <label>Approved and Forwarded by:</label>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <input type="file" class="form-control form-control-custom" id="signature" placeholder="">
                    </div>

                    <div class="col-md-6">
                        <label for="seal" style="float: right;">Seal of the Forest Division:</label>
