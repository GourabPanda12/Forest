<%@ Page Language="C#" AutoEventWireup="true" CodeFile="stationdiary.aspx.cs" Inherits="stationdiary" %>
         ...
         <div class="container" style="margin-top: 80px;">
            ...
            <h2 class="text-center" style="color: #fff;">FOREST DEPARTMENT, ODISHA </h2>
             ...
             <div class="row " style="margin-top:50px;">
                ...
                <h3 class="text-center" style="color: #000; font-size: 20px; padding-top: 30px;">STATION DIARY </h3>
