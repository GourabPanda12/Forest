<%@ Page Language="C#" AutoEventWireup="true" CodeFile="annual-Offence.aspx.cs" Inherits="annual_Offence" %>
...
<head>
    ...
    <title>ANNUAL REPORT ON FOREST CASES BOOKED </title>
...
<h2 class="end"> ANNUAL REPORT ON FOREST Offence CASES BOOKED FOR THE YEAR-2022-23 </h2>
    ...
    <table class="table table-bordered table-hover">
        ...
        <thead>
            <tr>
                ...
                <th colspan="3">No. of  Offence cases Booked</th>
                <th colspan="2">OR Cases </th>
                <th>No.of cases Sent to court</th>
                <th colspan="2">No. of Cases finalized in the Court</th>
                <th>No.of person involved</th>
                <th>No.of persons arrested </th>
                <th colspan="5">Offence cases Booked U/S-56 of OFA-1972 </th>
                <th>No..of vehicles Seized</th>
                <th>No..of vehicles Confiscated to Govt.</th>
                <th>Qnty of Timber 
                    (in Cum.)F.W ( inQntl)& others Forest produces Seized.</th>
                <th colspan="4">Value of seized produce (in Rs)</th>
                <th></th>
            </tr>
                </thead>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>O.R</td>
                        <td>Total</td>
                        <td>No.of Compounded</td>
                        <td> No.of PR cases</td>
                        <td> </td>
                        <td>No. of Cases convicted</td>
                        <td>No. of Cases acquitted</td>
                        <td></td>
                        <td></td>
                        <td>No.of Cases Booked</td>
                        <td>No. of Cases finalized</td>
                        <td>No.of Cases pending</td>
                        <td>No. of Persons arrested</td>
                        <td>Reason for pending of cases.</td>
                        <td></td>
                    <td></td>
                    <td></td>
                    <td>Vehicles</td>
                    ...
                    <td>poles</td>
                    <td>Others</td>
                    <td>Amount of compounding fees collected (in Rs.)</td>
                </tr>
                    ...
                    <tr>
                        ...
                        <td>18</td>
                        <td>9</td>
                        <td>Two Nos. of cases are under trial in the court of A.O. & other cases are pending due to non-submission of Final Report by the concerned Range Officers.</td>
                        <td>11</td>
                    <td>NIL</td>
                    <td>Timber=35.0324 cum.
                        FW=224.8 qtls.
                        KL=23.68 qtls.
                        Pole=164 Nos.
                        Murrum=6 cft.
                        </td>
                    <td>To be assessed by RTO.</td>
                    <td>866138/-
                        76432/-
                        </td>
                    <td>13120/-</td>
