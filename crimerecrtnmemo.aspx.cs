...
public partial class crimerecrtnmemo : System.Web.UI.Page
{
    ...
    public static string Insert(List<crmsData> jsonDynmxcxx)
    {
    ...
    public static List<crmsData> GetAutoCompleteData(string prefix)
    {
        List<crmsData> services = new List<crmsData>();
