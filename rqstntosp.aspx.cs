...
public partial class rqstntosp : System.Web.UI.Page
{
    ...
    public static string Insert(List<reqnspData> jsonDynmxcxx)
    {
    ...
    public static List<reqnspData> GetAutoCompleteData(string prefix)
    {
        List<reqnspData> services = new List<reqnspData>();
