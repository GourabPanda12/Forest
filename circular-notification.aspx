﻿<%@ Page Language="C#" AutoEventWireup="true" CodeFile="circular-notification.aspx.cs" Inherits="circular_notification" %>
...
<head>
    ...
    <script>
        ...
        $(document).ready(function () {
            $.ajax({
                type: "POST",
                url: "circular-notification.aspx/showrepo",
                data: '{}',
            ...
            function OnSuccessed(response) {
                var f = 1;
                $('#circular').html(""); // Clear the table before appending new data

                $.each(response.d, function (index, item) {
                    var data = item.split('*');

                    // Assuming the columns are: 0 -> id, 1 -> desdt, 2 -> desntfcn, 3 -> upldfile
                    $('#circular').append('<tr><td>' + f++ + '</td><td>' + data[1] + '</td><td>' + data[2] + '</td></tr>');
                });
            }
        });
        ...
        function sub() {
            ...
            $.ajax({
                type: "POST",
                url: "circular-notification.aspx/Insert",
                data: '{ descdt:"' + $("#txtdt").val() + '",descntfcn:"' + $("#txtdes").val() + '",pic:"' + $("#hiden").val() + '" ,path:"' + $("#hidden").val() + '"}',
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                    ...
                    <div class="col-11 col-sm-10 col-md-10 col-lg-11 col-xl-11 text-center p-0 mt-3 mb-2">
                        <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                            <div class="text-center">
                                ...
                                <h3 id="heading">Circular Notification</h3>
                        ...
                        <div class="login-form">
                          ...
                          <div class="row asd d-flex">
                                ...
                                <div class="col-lg-12  col-sm-12 col-xs-12 abc">
                                    ...
                                    <label class="lebl">Date of Notification</label>
<input type="date" id="txtdt" class="form-control console" placeholder="">
                            ...
                            <div class="col-lg-12  col-sm-12 col-xs-12 abc">
                                ...
                                <label class="lebl">Description of Notification</label>
<input type="text" id="txtdes" class="form-control console" placeholder="">
               ...
               <button class="btn btn-success" type="button" onclick="sub()" >Submit</button>
            
                                </div>



                              <table id="notificationTable" border="1" style="margin-top: 20px; width: 100%;">
    <thead>
        <tr>
            <th>Sl. No</th>
