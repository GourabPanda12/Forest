<%@ Page Language="C#" AutoEventWireup="true" CodeFile="petitionpdf.aspx.cs" Inherits="petitionpdf" %>
    ...
    <script>
        $(document).ready(function () {
            $("#btnGeneratePDF").click(function (event) {
                ...
                $.ajax({
                    type: "POST",
                    url: "GetData.asmx/GetPetitionPdf",
              ...
              //  doc.text(organizationName, pageWidth / 2, headerHeight / 2, { align: "center" });
               ...
               // doc.text(organizationAddress, pageWidth / 2, headerHeight / 2 + 10, { align: "center" });
                ...
                img.onload = function () {
                    ...
                    doc.addImage(img, 'PNG', 70, 3, 130, 25); // (image, format, x, y, width, height)
                    ...
                    img2.onload = function () {
                        ...
                        doc.addImage(img2, 'PNG', 10, 65, 260, 160); // Adjust position as needed
                        ...
                        textArray2.forEach(function (sentence) {
                           if (cf == 1) {
                               doc.text(60, 78, sentence);
                                doc.setFont("helvetica", "bold");
                                y += 10;
                            }
                            if (cf == 2) {
                                doc.text(170, 78, sentence);
                                doc.setFont("helvetica", "bold");
                                y += 10;
                            }
                            if (cf == 3) {
                                doc.text(110, 84, sentence);
                                doc.setFont("helvetica", "bold");
                                y += 10;
                            }
                            if (cf == 4) {
                                doc.text(195, 84, sentence);
                                doc.setFont("helvetica", "bold");
                                y += 10;
                            }
                            if (cf == 5) {
                                doc.text(20, 90, sentence);
                                doc.setFont("helvetica", "bold");
                                y += 10;
                            }
                    ...
                    img2.src = 'pdfimages/petition.jpg';




                };
                img.src = 'pdfimages/FORM-IV-COMPOUNGING-PETITION_Header.jpg';
