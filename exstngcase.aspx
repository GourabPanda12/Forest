<%@ Page Language="C#" AutoEventWireup="true" CodeFile="exstngcase.aspx.cs" Inherits="exstngcase" %>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"
	...
	<title>Accused Forwarding</title>
...
<h2 class="text-center" style="color: #fff;">Existing Cases</h2>
                      ...
                      <div class="col-md-10  col-12 mx- auto offset-md-1">
                        ...
                        <div class="login-form">
                          ...
                          <div class="row asd d-flex">
                              ...
                              <label class="lebl">Search Command Certificate No</label>
                          <input type="text" id="txtcno" class="form-control console" placeholder="">
                                   </div>
                                  <div class="col-lg-6  col-sm-6 col-xs-6 abc">
                                               <label class="lebl">Search FIR No</label>
                                      <input type="text" id="txtfir" class="form-control console" placeholder="">
                                      </div>
                                <div class="col-lg-6  col-sm-6 col-xs-6 abc">

                              <label class="lebl">Search From Date</label>
                                      <input type="date" id="txtfir1" class="form-control console" placeholder="">
                              ...
                              <label class="lebl">Search To Date</label>
                                      <input type="date" id="txtfir12" class="form-control console" placeholder="">
                            ...
                            <div class="col-lg-6  col-sm-6 col-xs-6 abc">
                             ...
                             <button class="btnx mt-4" type="button" onclick="sub()" >Search</button>
