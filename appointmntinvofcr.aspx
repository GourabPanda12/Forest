<%@ Page Language="C#" AutoEventWireup="true" CodeFile="appointmntinvofcr.aspx.cs" Inherits="appointmntinvofcr" %>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"
 ...
 <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.5.14/jspdf.plugin.autotable.min.js"></script>
	...
	<title>Appointment Of Investing Officer</title>
    ...
    <script type="text/javascript">
        ...
        function print() {
          ...
          //  doc.text('Phone: (123) 456-7890', pageWidth / 2, margin + 95, { align: 'center' });
            ...
            doc.text("FIR Copy", pdfWidth / 2, topMargin + 15, { align: "center" });
            ...
            doc.save('case-document-appointmntinvofcr.pdf');
...
<h2 class="text-center" style="color: #fff;">Appointment Of Investing Officer</h2>
