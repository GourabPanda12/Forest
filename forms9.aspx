﻿<%@ Page Language="C#" AutoEventWireup="true" CodeFile="forms9.aspx.cs" Inherits="forms9" %>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"
    ...
    <script>
        ...
        function sub() {
            ...
            var bookno = $("#txtbkno").val();
            var slno = $("#txtslno").val();
            var caseno = $("#txtcaseno").val();
            var date = $("#txtdt").val();
            var reformino = $("#txtref").val();
            ...
            $.ajax({
                type: "POST",
                url: "forms9.aspx/Insert",
                data: "{casediarylist:" + JSON.stringify(casediarylist) + "}",
                ...
                <div class="col-11 col-sm-10 col-md-10 col-lg-11 col-xl-11 text-center p-0 mt-3 mb-2">
                    <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                         <div class="text-center">
                          ...
                          <p id="heading1">CASE DIARY</p>
                          <p id="heading12">
                            UNDER SECTION 192 OF THE BHARATIYA NAGARIK SURAKSHA SANHITA, 2023
                                          ...
                                          <div class="login-form">
                                            ...
                                            <div class="row asd d-flex">
                                                ...
                                                <div class="col-lg-6  col-sm-6 col-xs-6 abc">
                                                  ...
                                                  <label class="lebl">Book No</label>
    
                                                  <input type="text" id="txtbkno" class="form-control console" placeholder="Book No"  >
    
    
    
    
    
                                                  <label class="lebl">Case No</label>
    
                                                  <input type="text" id="txtcaseno" class="form-control console" placeholder="Case No"  >
                                              ...
                                              <div class="col-lg-6 col-sm-6 col-xs-6 abc">
                                                ...
                                                <label class="lebl">Serial No</label>
                                                  ...
                                                  <input type="text" id="txtslno" class="form-control console" placeholder="Serial No"  >
                                                  ...
                                                  <input type="date" id="txtdt" class="form-control console" placeholder=""  >
                                                                    ...
                                                                    <label class="lebl">Reference Form –I </label>

                                                                    <input type="text" id="txtref" class="form-control console" placeholder="">
                                                                </div>
                            ...
                            <div class="row asd d-flex">
                                ...
                                <div class="col-lg-12  col-sm-12 col-xs-12 abc">
                                  ...
                                  <div class="row">
                                    ...
                                    <h3 style="color:#000;letter-spacing: 1px;font-size: 17px;" class="mt-2 mb-3">Case-101</h3>
                                    ...
                                    <div class="col-lg-3  col-sm-3 col-xs-3 abc">
                                      ...
                                      <label class="lebl">Time</label>
                                       <input type="time" id=""  class="form-control console" placeholder="">
                                      </div>
                                      <div class="col-lg-6  col-sm-6 col-xs-6 abc">
                                  
                                        <label class="lebl">Description</label>
                  ...
                  <div class="row " style="margin-top:-31px;">
                      <div class="col-md-10  col-12 mx- auto offset-md-1">
                        ...
                        <div class="login-form">
                          ...
                          <button class="btny mt-4" type="button" onclick="window.location.href='form9pdf.aspx'">Download Pdf</button>
