<%@ Page Language="C#" AutoEventWireup="true" CodeFile="crimedtls.aspx.cs" Inherits="crimedtls" %>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"
	...
	<title>Crime Details Form</title>
            ...
            <h2 class="text-center" style="color: #fff;">FOREST DEPARTMENT, ODISHA </h2>
                ...
                <div class="col-md-10  col-12 mx- auto offset-md-1">
                   <div class="login-form">
                      <div class="row asd d-flex">
                        ...
                        <div>
                            <h4 class="text-center" style="color: #000; margin-top: 30px;">CRIME DETAILS FORM</h4>
                        </div>
             ...
             <form>
                <div class="row pt-4">
                    ...
                    <div class="col-md-6">
                        <label for="dateTime">FIR No:</label>
                        <input type="text" class="form-control" id="dateTime" placeholder="">
                    </div>
                    <div class="col-md-6">
                        <label for="refNumber">1. Name of The Division :</label>
                        <input type="text" class="form-control form-control-custom" id="signature" placeholder="">
                    </div>
                   
                    <div class="col-md-6">
                        <label for="dateTime">Name of The Range :</label>
                        <input type="text" class="form-control" id="dateTime" placeholder="">
                    </div>
                </div> 
                ...
                <div class="row pt-3 pb-3">
                    <div class="col-md-4">
                        <label for="refNumber">Year :</label>
                        <input type="number" class="form-control form-control-custom" id="signature" placeholder="">
                    </div>
                   
                    <div class="col-md-4">
                        <label for="dateTime">OR No. :</label>
                        <input type="text" class="form-control" id="dateTime" placeholder="">
                    </div>
                 ...
                 <div class="form-group form-section">
                     <label for="from">2. Acts and Sections :</label>
                     <input type="text" class="form-control" id="from" placeholder="">
                 </div>

                 <div class="form-group form-section">
                    <label for="from">3. The Place of Occurrence Shown by Name :</label>
                    <input type="text" class="form-control" id="from" placeholder="">
                </div>

                <div class="form-group form-section">
                    <label for="from">4. Motive of Crime :</label>
                ...
                <div class="row pt-4 pb-3">
                    <h6 class="" style="color: #000;">5. Date and time of Visit to the Place of Occurrence : </h6>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="time" class="form-control" id="dateTime" placeholder="">
                    </div>
                </div> 

                 <div class="form-group form-section">
                     <label for="address">6. Description of the Place of Occurrence Sketch / Map , if any (attach separately with legend) :</label>
                 ...
                 <div class="row pt-4 pb-3">
                    <div class="col-md-6">
                        <label for="refNumber">Place :</label>
                        <input type="text" class="form-control" id="dateTime" placeholder="">
                    </div>
                   
                    <div class="col-md-6">
                        <label for="dateTime">Signature of the Investigating Officer :</label>
                        <input type="file" class="form-control" id="dateTime" placeholder="">
                    </div>
                </div> 

                <div class="row pb-3">
                    <div class="col-md-6">
                        <label for="refNumber">With Seal :</label>
                    </div>
                ...
                <div class="row pb-5">
                    ...
                    <div class="col-md-6">
                        <label for="dateTime">Designation :</label>
                        <input type="text" class="form-control" id="dateTime" placeholder="">
                    </div>
                </div> 
