﻿<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rqstntosp.aspx.cs" Inherits="rqstntosp" %>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"
 ...
 <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.5.14/jspdf.plugin.autotable.min.js"></script>
	...
	<title>Requisition to SP for Forensic examination of digital evidence such as photography and videography during seizure/crime scene recreation/ discovery of spot/weapon/trap by accused</title>
    ...
    <script type="text/javascript">
        ...
        function print() {
            ...
            doc.text("Requisition to SP for Forensic examination of digital evidence \n"+
                      "such as photography and videography during seizure / crime \n" +
                      "scene recreation / discovery of spot / weapon / trap by accused", pdfWidth / 2, topMargin + 25, { align: "center" });

            // Set initial y position below the gradient header
            let yPosition = topMargin + gradientHeight + 38;
            doc.setFontSize(12);
            ...
            doc.save('case-document-rqstntosp.pdf');
              ...
              <ul>
                 ...
                 <li><a href="deputationoder.aspx">Deputation order of witnesses by concerned authority</a></li>
                  ...
                  <li><a href="aftersearch.aspx">After search protocol</a></li>
                   ...
                   <li><a href="fircopy.aspx">Requisition to SP for Forensic examination of digital evidence such as photography and videography during seizure/crime scene recreation/ discovery of spot/weapon/trap by accused</a></li>
...
<h2 class="text-center" style="color: #fff;">Requisition to SP for Forensic examination of digital evidence such as photography and videography during seizure/crime scene recreation/ discovery of spot/weapon/trap by accused</h2>
