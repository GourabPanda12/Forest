<%@ Page Language="C#" AutoEventWireup="true" CodeFile="srchforest.aspx.cs" Inherits="srchforest" %>
    ...
    <form id="form1" runat="server">
      ...
      <aside id="sidebar" style="display:none;">
        <!--
         ...
         <li class="sub-menu">
        <a href="srchwildlife.aspx" target="
_blank" style=>
    ...
    <div class="container" style="margin-top:50px;">
        <div class="row">
            ...
            <div class="col-sm-4 col-md-4 col-lg-4 mb-4">
                <a href="oldcasefo.aspx" class="card-link">
                    <div class="card">
                        <div class="card-body">
                        <span><i class="fa fa-pagelines treexx" aria-hidden="true"></i></span>
                            
                            
                            <h5 class="card-title text-center">Existing Cases/FIR</h5>
			  ...
			  <div class="col-sm-4 col-md-4 col-lg-4 mb-4">
                <a href="newcasefo.aspx" class="card-link">
                    <div class="card">
                        <div class="card-body">
                            <span> <i class="fa fa-leaf treex" aria-hidden="true"></i></span>
                           
                            <h5 class="card-title text-center">New Cases/FIR</h5>
                            <p class="card-text text-center">BLACK TIGER</p>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-sm-4 col-md-4 col-lg-4 mb-4">
                <a href="https://msksoftware.co.in/forestdoc/allcasesfo.aspx" class="card-link">
                    <div class="card">
                        <div class="card-body">
                            <span> <i class="fa fa-address-book-o treex" aria-hidden="true"></i></span>
                           
                            <h5 class="card-title text-center">Cases Summary/Log</h5>
                            <p class="card-text text-center">BLACK TIGER</p>
                        </div>
                    </div>
                </a>
