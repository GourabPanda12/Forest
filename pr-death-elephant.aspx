<%@ Page Language="C#" AutoEventWireup="true" CodeFile="pr-death-elephant.aspx.cs" Inherits="pr_death_elephant" %>
...
<head>
    ...
    <title>PR ON DEATH OF ELEPHANT</title>
...
<h2 class="end">PRELIMINARY REPORT ON  DEATH OF  ELEPHANT</h2>
...
<tbody>
    <tr>
        <td>(i)</td>
        <td>(a)</td>
        <td>Date and time of detection</td>
        <td>:</td>
        <td></td>
    </tr>
    ...
    <tr>
        <td>(ii)</td>
        <td></td>
        <td>Period of death (approximately)/How old is the carcass</td>
        <td>:</td>
        <td></td>
    </tr>
    ...
    <tr>
        <td>(iii)</td>
        <td></td>
        <td>Brief details of remains fund
            (Skin / Bones/Skull/etc.)
            </td>
        <td>:</td>
        <td></td>
    </tr>
    ...
    <tr>
        <td>(iv)</td>
        <td></td>
        <td>If a tusker then it should be intimated if tusks are intact / removed.</td>
        <td>:</td>
        <td></td>
    </tr>
    ...
    <tr>
        <td>(v)</td>
        <td></td>
        <td>Details of seizure effected / field recoveries</td>
        <td>:</td>
        <td></td>
    </tr>
    <tr>
        ...
        <td></td>
        <td>Extract location
            GPS locations, Name of RF, PRF with compartment No. and Name of revenue forest may also be mentioned if it is in a forest area
            </td>
        <td>:</td>
        <td><p>N-</p>
            <p>E-</p>
           ...
           <p>Sec-</p>
           <p>Range- </p>
            <p>Under BLACK TIGER.</p>
            </td>
    </tr>
    <tr>
        <td>(vii)</td>
        <td></td>
        <td>Spot Observation</td>
        <td>:</td>
        <td></td>
    </tr>
    ...
    <tr>
        <td>(viii)</td>
        <td></td>
        <td>Source of information about death</td>
        <td>:</td>
        <td></td>
    </tr>
    <tr>
        <td>(ix)</td>
        <td></td>
        <td>Number of elephant trackers engaged in that particular area</td>
        <td>:</td>
        <td></td>
    </tr>
    <tr>
        <td>(x)</td>
        <td></td>
        <td>Name and designation of the investing officer</td>
        <td>:</td>
        <td></td>
    </tr>
    ...
    <tr>
        <td>(xi)</td>
        <td></td>
        <td>Distance from nearest village/human settlements.</td>
        <td>:</td>
        <td></td>
    </tr>
    <tr>
        <td>(xii)</td>
        <td></td>
        <td>Distance from nearest forest beat house</td>
        <td>:</td>
        <td></td>
    </tr>
    <tr>
        <td>(xiii)</td>
        <td></td>
        <td>Prima facie cause of death</td>
        <td>:</td>
        <td></td>
    </tr>
...
<label class="custom-control-label" for="customCheck1" style="font-weight: 600; color: #fff;">Check </label>

<div class="table-responsive">
    <table class="table table-bordered table-hover">
        <thead class="text-center">
            <tr>
                <th rowspan="2">Poaching</th>
                <th rowspan="2">Poisoning</th>

                <th colspan="2">Electrocution</th>
                <th rowspan="2">Snaring</th>
                <th colspan="3">Accident</th>
                <th rowspan="2">Disease
		
                </th>
                <th rowspan="2">Natural</th>
                <th rowspan="2">Not known</th>
                ...
                <tr>
                    ...
                    <th>Train</th>
                    <th>Road</th>
                    <th>Infighting / other accident</th>
                </tr>
...
<tbody>
    <tr>
        <td>(xiv)</td>
        <td></td>
        <td>Name of the offender(s), if any?
    ...
    <tr>
        <td>(xv)</td>
        <td></td>
        <td>Last death case of elephants reported from the area/beat</td>
        <td>:</td>
        <td></td>
    </tr>
        ...
        <p class="ppl">Divisional Forest Officer-cum,</p>

            <p  class="ppl" style="margin-top: -20px;"> Wildlife Warden,</p>
