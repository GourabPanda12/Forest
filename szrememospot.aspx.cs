...
public partial class szrememospot : System.Web.UI.Page
{
    ...
    public static string Insert(List<seizurData> jsonDynmxcxx)
    {
    ...
    public static List<seizurData> GetAutoCompleteData(string prefix)
    {
        List<seizurData> services = new List<seizurData>();
