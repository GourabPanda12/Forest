<%@ Page Language="C#" AutoEventWireup="true" CodeFile="vhstmnt.aspx.cs" Inherits="vhstmnt" %>
    ...
    <script type="text/javascript">
        ...
        function print() {
         ...
         //   doc.text('Phone: (123) 456-7890', pageWidth / 2, margin + 95, { align: 'center' });
            ...
            doc.text("Statement Of Vehicle Owner", pdfWidth / 2, topMargin + 15, { align: "center" });
...
<h2 class="text-center" style="color: #fff;text-transform:uppercase;">Statement Of Vehicle Owner</h2>
