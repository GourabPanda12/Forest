<%@ Page Language="C#" AutoEventWireup="true" CodeFile="disposal-or.aspx.cs" Inherits="disposal_or" %>
...
<head>
    ...
    <title>HY PROGRESS REPORT ON DISPOSAL OF SEIZED PRODUCE (OR)</title>
...
<h2 class="end">HALF YEARLY PROGRESS REPORT ON DISPOSAL OF SEIZED PRODUCE FOR  SEPTEMBER,2023 (FROM 01.04.2023 TO 30.09.2023) BLACK TIGER RELATING TO   O.R.CASES </h2>
    ...
    <table class="table table-bordered table-hover">
        ...
        <thead>
            <tr>
                ...
                <th rowspan="2">Total stock of forest produce (3+4) </th>
                <th rowspan="2">Compounding</th>
                <th colspan="3">Quantity of forest produce disposal</th>
