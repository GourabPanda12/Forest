<%@ Page Language="C#" AutoEventWireup="true" CodeFile="malhnadtls.aspx.cs" Inherits="malhnadtls" %>
                ...
                <div class="col-md-10  col-12 mx- auto offset-md-1">
                   <div class="login-form">
                      <div class="row asd d-flex pt-5">
                        <h3 class="text-center" style="color: #000;">MAL CHALAN</h3>
                    
                        <div class="row mt-5>" style="margin: 20px 0">
                            ...
                            <div class="col-md-6" style="margin-bottom: 5px;">
                                <label for="refNumber">FIR No: </label>
                                <input type="text" class="">
                            </div>
                            <div class="col-md-6" style="margin-bottom: 5px;">
                                <label for="refNumber">Ref:-QR Case No: </label>
                                <input type="text" class="">
                            </div>
                            <div class="col-md-6">
                                <label for="refNumber">CMR No: </label>
                                <input type="text" class="">
                            </div>
                            <div class="col-md-6">
                                <label for="refNumber">Range Office MR: </label>
                                <input type="text" class="">
                            </div>
                        </div>
                        <div class="row" style="margin-bottom: 15px;">
                            <div class="col-md-12">
                                <label for="refNumber">Description of Mal items : </label>
                                <input type="text" class="form-control">
                            </div>
                            <div class="col-md-12">
                                <label for="refNumber">To whome sent : </label>
                                <input type="text" class="form-control">
                            </div>
                            <div class="col-md-12">
                                <label for="refNumber">(T) whome sent : </label>
                                <input type="text" class="form-control">
                            </div>
                            <div class="col-md-12">
                                <label for="refNumber">Remark : </label>
                                <input type="text" class="form-control">
                            </div>
                            <div class="col-md-12">
                                <label for="refNumber">Case Ref. : </label>
                                <input type="text" class="form-control">
                            </div>
                        </div>
                        <div class="row" style="margin-bottom: 15px;">
                            <div class="col-md-5">
                                <label for="refNumber">Signature of Recieving Officer : </label>
                                <input type="file" class="form-control">
                            </div>
                            <div class="col-md-5">
                                <label for="refNumber">Signature of Forwarding Officer : </label>
                                <input type="file" class="form-control">
