...
public partial class finalpmstemrepo : System.Web.UI.Page
{
    ...
    public static string Insert(List<pormtData> jsonDynmxcxx)
    {
    ...
    public static List<pormtData> GetAutoCompleteData(string prefix)
    {
        List<pormtData> services = new List<pormtData>();
