<%@ Page Language="C#" AutoEventWireup="true" CodeFile="spotmap.aspx.cs" Inherits="spotmap" %>
 ...
 <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.5.14/jspdf.plugin.autotable.min.js"></script>
    ...
    <script type="text/javascript">
       ...
       //     doc.text('Phone: (123) 456-7890', pageWidth / 2, margin + 95, { align: 'center' });
            ...
            doc.text("Spot Map", pdfWidth / 2, topMargin + 15, { align: "center" });
...
<h2 class="text-center" style="color: #fff;">SPOT MAP</h2>
