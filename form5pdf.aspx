<%@ Page Language="C#" AutoEventWireup="true" CodeFile="form5pdf.aspx.cs" Inherits="form5pdf" %>
        ...
        $(document).ready(function () {
            ...
            function generatePDF(data) {
                ...
                img.onload = function () {
                    ...
                    doc.text(10, 10, "Arrest Memo no ARDFS/24/AN003");
                    ...
                    img2.onload = function () {
                      ...
                      //  yPosition2 = 20;
                        ...
                        doc.addImage(img2, 'PNG', 10, 25, 220,180); // Adjust position as needed
                        ...
                        var textArray2 = [
                            "DCFNP67u90",
                            "23-08-2023 11:34 AM",
                            "Canivas Plantation in forest",
                            "sukanta kandha adibasi",
                            "Chandrabhanu Mohanty",
                            "bisu swain, dhiasahi, shop keeper, 8799034556",
                            "Yes",
                            "mahakulda brother, jhuna mother, ",
                            "No injuries found",
                            "Big Black mole on left forearm",
                            
                            "Yes ACFN786yuoi (accused form ref no)",
                            "Nothing"
                        ];

                        // Initial y position for text below the second image

                        textArray2.forEach(function (sentence, index) {
                            if (index >= 5) {
                                doc.text(165, yPosition2, sentence);
                                yPosition2 += 18;
                            }
                            else {
                                doc.text(165, yPosition2, sentence);
                            ...
                            // Increment y position for the next sentence
                        });
                        ...
                        img3.onload = function () {
                            ...
                            doc.addImage(img3, 'PNG', 1, 5, 270, 180); // Adjust position as needed
                            ...
                            img7.onload = function () {
                                ...
                                doc.addImage(img7, 'PNG', 1, yPosition2, 270, 160); // Adjust position as needed
                            ...
                            img7.src = 'pdfimages/arrest4.jpg';
                            // Save the PDF after all images and associated text have been added
                           // doc.save('example.pdf');
                        };

                        img3.src = 'pdfimages/arrest2.jpg';
                    };

                    img2.src = 'pdfimages/arrest1.jpg';




                };
                img.src = 'pdfimages/armemo.jpg';
