<%@ Page Language="C#" AutoEventWireup="true" CodeFile="record-holding.aspx.cs" Inherits="record_holding" %>
...
<h2 class="end">Half Yearly  Recorded  Holding Report of  Sambalpur Forest  Division </h2>
    ...
    <table class="table table-bordered table-hover">
        <thead>
            <tr>
             ...
             <th rowspan=2>No.of purchasers/No.of Tenants/No of Cases</th>
             <th rowspan=2>No.of plots</th>
             <th rowspan=2>Total area of the plot Ac/Dec</th>
             ...
             <th colspan=4>No.of trees removed</th>
             ...
             <th colspan=4>Quantity of timber removed in (cum.)</th>

               <th rowspan=2>Total (cum.)</th>
               <th rowspan=2>No.of Bamboo Removed</th>
               <th rowspan=2>Quantity of F.W. Removed (in stack)12'X3'X3' size</th>
               <th rowspan=2>Total</th>
