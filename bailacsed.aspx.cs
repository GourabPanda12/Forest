...
public partial class bailacsed : System.Web.UI.Page
{
    ...
    public static string Insert(List<valcaData> jsonDynmxcxx)
    {
    ...
    public static List<valcaData> GetAutoCompleteData(string prefix)
    {
        List<valcaData> services = new List<valcaData>();
