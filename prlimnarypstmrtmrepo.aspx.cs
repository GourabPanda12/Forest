...
public partial class prlimnarypstmrtmrepo : System.Web.UI.Page
{
    ...
    public static string Insert(List<prlmData> jsonDynmxcxx)
    {
    ...
    public static List<prlmData> GetAutoCompleteData(string prefix)
    {
        List<prlmData> services = new List<prlmData>();
