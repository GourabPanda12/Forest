<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rescue-release.aspx.cs" Inherits="rescue_release" %>
...
<h2 class="end">RESCUE AND RELEASE OF WILD LIFE</h2>




<p id="heading1">FORM: D-V</p>

<p id="heading1">Name of the Division  :- BLACK TIGER  </p>
<p id="heading1">Name of the Circle:- SAMBALPUR</p>
 <p id="heading1">MONTH :- DECEMBER-2023</p>
...
<div class="table-responsive" style="margin-top: 40px;">
    <table class="table table-bordered table-hover">
        ...
        <thead>
            <tr>
                <th rowspan="3">Name of the  Division.</th>
...
<p id="heading1">FORM: D-IV</p>

    <p id="heading1">MONTHLY PROGRESS REPORT ON WILDLIFE Offence CASES BOOKED</p>
        ...
        <p id="heading1">Name of the Division : BLACK TIGER</p>
            ...
            <p id="heading1">Name of the Circle : Sambalpur</p>
                ...
                <p id="heading1">MONTH :- DECEMBER-2023</p>
                    ...
                    <p id="heading1">PART-I   Offence CASES BOOKED</p>
    ...
    <table class="table table-bordered table-hover">
        <thead>
            <tr>
                ...
                <th colspan="4">Status of disposal
                    (Progressive total)
                </th>
            </tr>
...
<div style="margin-top: 30px;">
    <p id="heading1">
        ...
        <p id="heading1">PART-II-  STATUS OF SEIZED WILD ANIMAL/TROPHY/OTHER MATERIAL ETC</p>
...
<div class="table-responsive" style="margin-top: 40px;">
    <table class="table table-bordered table-hover">
        <thead>
            <tr>
                <th>Name of wild animal</th>
                <th colspan="2">No.</th>
                <th>Details of trophy skin/tusk/ Derivatives and others </th>
                <th>Details of Arms & ammunitions</th>
                <th>Vehicle seized if any</th>
...
<div style="margin-top: 30px;">
    <p id="heading1">
        ...
        <p id="heading1">
            ...
            PART-III (DETAILS ON IMPORTANT WILDLIFE CASES BOOKED DURING THE MONTH)
    ...
    <table class="table table-bordered table-hover">
        ...
        <thead>
            <tr>
                ...
                <th>Property 
                    Recovered
                    (Live/dead animal/ other material etc.(in detail)
                    </th>
                <th>Name,
                    Age And address
                    of the accused.
                ...
                <th>Date of 
                    Arrest and forwarding to the court
                    </th>
                <th>Name of the court
                    And court case No.
                    </th>
...
<div style="margin-top: 30px;">
    <p id="heading1">
        ...
        <p id="heading1">
            ...
            MPR ON   DEATH OF WILD ANIMALS </p>
            <p id="heading1"> Name of the Division- BLACK TIGER</p>
            <p id="heading1">MONTH :- DECEMBER-2023</p>
            <p id="heading1">Name of the Circle - SAMBALPUR CIRCLE </p>
            <p id="heading1">  DEATH OF WILD ANIMALS </p>
        ...
        <table class="table table-bordered table-hover">
            <thead>
                ...
                <tr>
                    ...
                    <th>Un Identified sex</th>
                    <th>Total</th>
                    <th>Remarks( Whether coming under PA/Sanctuary area)</th>
            ...
            <div style="margin-top: 40px;margin-bottom: 30px; float: left;">
                <p id="heading1">

            Causes of death to be mentioned as :</p>
            <p id="heading1">
                1. Poaching</p>
                <p id="heading1">
                    2. Poisoning</p>
                    <p id="heading1">
                        3. Deliberate electrocution.</p>
                        <p id="heading1">
                            4 .Accidental electrocution</p>
                            <p id="heading1">
                                5. Rail Accident.</p>
                                <p id="heading1">
                                    6. Other Accident.</p>
...
<div style="margin-top: 30px;">
    <p id="heading1">
        ...
        <p id="heading1">
            ...
            Name of the Division :- BLACK TIGER                                            
            

            </p>
            <p id="heading1"> MPR ONTIGER AND LEOPARD EVIDENCES</p>
            <p id="heading1">MONTH - DECEMBER-2023</p>
