<%@ Page Language="C#" AutoEventWireup="true" CodeFile="beforesearchpdf.aspx.cs" Inherits="beforesearchpdf" %>
        ...
        $(document).ready(function () {
            ...
            function generatePDF(data) {
                ...
                img.onload = function () {
                    ...
                    doc.addImage(img, 'PNG', 20, 1, 240, 60); // (image, format, x, y, width, height)
                    ...
                    img2.onload = function () {
                        ...
                        img3.onload = function () {
                            ...
                            //  var yPosition3 = 130; // Initial y position for text below the third image
                            yPosition2 += 30;
                            ...
                            img4.onload = function () {
                                ...
                                doc.addImage(img4, 'PNG', 1, yPosition2, 290, 20); // Adjust position as needed
                                ...
                                //  var yPosition3 = 130; // Initial y position for text below the third image
                                yPosition2 += 30;
                                textArray4x.forEach(function (sentence) {
                                    doc.text(15, yPosition2, sentence);
                                    yPosition2 += 10; // Increment y position for the next sentence
                                });
                                var img5 = new Image();
                                ...
                                img5.onload = function () {
                                    // Add third image below the second image
                                    doc.addImage(img5, 'PNG', 1, yPosition2, 290, 20); // Adjust position as needed
                                    ...
                                    //  var yPosition3 = 130; // Initial y position for text below the third image
                                    yPosition2 += 30;
                                    textArray4.forEach(function (sentence) {
                                        doc.text(15, yPosition2, sentence);
                                        yPosition2 += 10; // Increment y position for the next sentence
                                    });
                                    ...
                                    img6.onload = function () {
                                        // Add third image below the second image
                                        doc.addImage(img6, 'PNG', 1, yPosition2, 290, 20); // Adjust position as needed
                                    ...
                                    img6.src = 'pdfimages/AFTER SEARCH PROTOCOL_page-0001 (6).jpg';
                                };
                                img5.src = 'pdfimages/AFTER SEARCH PROTOCOL_page-0001 (5).jpg';
                            };

                            img4.src = 'pdfimages/AFTER SEARCH PROTOCOL_page-0001 (3).jpg';
                        };
                ...
                img.src = 'pdfimages/before-search-protocol_Header.jpg';
