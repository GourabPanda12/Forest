<%@ Page Language="C#" AutoEventWireup="true" CodeFile="revenueinsprepo.aspx.cs" Inherits="revenueinsprepo" %>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"
 ...
 <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.5.14/jspdf.plugin.autotable.min.js"></script>
	...
	<title>Revenue Inspector Report</title>
    ...
    <script type="text/javascript">
        ...
        function print() {
          ...
          //  doc.addImage(imgData, 'PNG', logoX, margin, logoWidth, logoHeight); // Position and size of the logo
            ...
            doc.text("Revenue Inspector Report", pdfWidth / 2, topMargin + 15, { align: "center" });
            ...
            doc.save('case-document-revenueinsprepo.pdf');
              ...
              <ul>
                 ...
                 <li><a href="deputationoder.aspx">Deputation order of witnesses by concerned authority</a></li>
                  ...
                  <li><a href="aftersearch.aspx">After search protocol</a></li>
                   ...
                   <li><a href="fircopy.aspx">Revenue Inspector Report</a></li>
...
<h2 class="text-center" style="color: #fff;">Revenue Inspector Report</h2>
