<%@ Page Language="C#" AutoEventWireup="true" CodeFile="report-demand.aspx.cs" Inherits="report_demand" %>
...
<head>
    ...
    <title>HY REPORT ON DEMAND, COLLECTION & BALANCE</title>
...
<h2 class="end">  Halp Yearly  Progress Report On Demand Collection And Balance Of BLACK TIGER </h2>
...
<div class="table-responsive">
    <table class="table table-bordered table-hover">
        <thead>
            <tr>
                <th rowspan=2>Name Of The Division</th>
                <th rowspan=2>Item</th>



             <th colspan=4>O.F.D.C. Ltd.</th>
             <th rowspan=2>Total(2+3+4+5)3+4+5+6</th>

               <th rowspan=2>Forest Contractors</th>
             <th rowspan=2>T.D.C.C. Ltd</th>

             <th rowspan=2>Public Auction</th>
             <th rowspan=2>Other Agency (O.P.Mills)</th>
             <th rowspan=2>Grand Total</th>
             </tr>
                <tr>
                <th>Timber & firewood</th>
                <th>Salseed</th>
                <th>Bamboo</th>
                <th>Kenduleaf</th>
              </tr>
...
<tr>
    ...
    <td><b>D E M A N D</b>
        ...
        (i+ii)
       <b> COLLECTION</b>
        iv)Collection out of arrear
        v)Collection out of current Demand
        vi)Total Collection during the quarter
        B A L A N C E As On
        vii)Balance out of Arrear
        viii)Balance out of current Demand ( -)
        ix) <b>Total balance</b>
    </td>
    <td></td>
    <td></td>
    <td></td>
    ...
    <td></td>
            ...
            <div style="float: left; padding-top: 7px;" class="re">
                <p class="ppl"> Rs. Belated payment of interest on regular timber coupes</p>
                <p class="ppl" style="margin-top: -20px;">Rs. Disputed Roylty</p>
                </div>
