<%@ Page Language="C#" AutoEventWireup="true" CodeFile="dforprt.aspx.cs" Inherits="dforprt" %>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"
 ...
 <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.5.14/jspdf.plugin.autotable.min.js"></script>
	...
	<title>Dfo/Jtf/Other Experts</title>
        ...
        function print() {
         ...
         //   doc.addImage(imgData, 'PNG', logoX, margin, logoWidth, logoHeight); // Position and size of the logo
           ...
           // doc.text('Phone: (123) 456-7890', pageWidth / 2, margin + 95, { align: 'center' });
            ...
            doc.text("Dfo/Jtf/Other Experts", pdfWidth / 2, topMargin + 25, { align: "center" });
            ...
            doc.save('case-document-dforprt.pdf');
              ...
              <ul>
                 ...
                 <li><a href="deputationoder.aspx">Deputation order of witnesses by concerned authority</a></li>
                  ...
                  <li><a href="aftersearch.aspx">After search protocol</a></li>
                   ...
                   <li><a href="fircopy.aspx">Dfo/Jtf/Other Experts</a></li>
...
<h2 class="text-center" style="color: #fff;">Dfo/Jtf/Other Experts</h2>
