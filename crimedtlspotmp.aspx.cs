...
public partial class crimedtlspotmp : System.Web.UI.Page
{
    ...
    public static string Insert(List<crmsptData> jsonDynmxcxx)
    {
    ...
    public static List<crmsptData> GetAutoCompleteData(string prefix)
    {
        List<crmsptData> services = new List<crmsptData>();
