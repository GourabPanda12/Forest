<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Default55.aspx.cs" Inherits="Default55" %>
 ...
 <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.5.14/jspdf.plugin.autotable.min.js"></script>
    ...
    <script type="text/javascript">
      ...
      //      doc.text('Phone: (123) 456-7890', pageWidth / 2, margin + 95, { align: 'center' });
            ...
            doc.text("Call Detail Records", pdfWidth / 2, topMargin + 15, { align: "center" });
...
<h2 class="text-center" style="color: #fff;">Call Detail Records</h2>
