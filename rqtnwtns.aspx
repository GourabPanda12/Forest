<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rqtnwtns.aspx.cs" Inherits="rqtnwtns" %>
    ...
    <script type="text/javascript">
      ...
      $('#submitFiles').click(function () {
        ...
        function print() {
          ...
          //  doc.addImage('', 'PNG', logoX, margin, logoWidth, logoHeight); // Position and size of the logo
            ...
            doc.text("Requisition For Independent Witness", pdfWidth / 2, topMargin + 25, { align: "center" });
...
<h2 class="text-center" style="color: #fff;">Requisition For Independent Witness</h2>
