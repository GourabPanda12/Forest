<%@ Page Language="C#" AutoEventWireup="true" CodeFile="finalpdf.aspx.cs" Inherits="finalpdf" %>
        ...
        $(document).ready(function () {
            ...
            function generatePDF(data) {
                ...
                img.onload = function () {
                    ...
                    doc.addImage(img, 'PNG', 40, 1, 210, 45); // (image, format, x, y, width, height)
                    ...
                    img2.onload = function () {
                        ...
                        doc.addImage(img2, 'PNG', 40, 55, 220, 140); // Adjust position as needed
                        ...
                        img3.src = 'pdfimages/final2.jpg';
                    };

                    img2.src = 'pdfimages/final1.jpg';




                };
                img.src = 'pdfimages/finalrepo.jpg';
