﻿﻿<%@ Page Language="C#" AutoEventWireup="true" CodeFile="searchwrnt.aspx.cs" Inherits="searchwrnt" %>
 ...
 <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.5.14/jspdf.plugin.autotable.min.js"></script>
    ...
    `;
        ...
        function print() {
            ...
            doc.text("[Section-50(8)(a) of the Wildlife (Protection) Act, 1972]", 55, 28);
                ...
                <div class="col-md-10  col-12 mx- auto offset-md-1">
                   <div class="login-form">
                      <div class="row asd d-flex pt-5">
                        <h2 class="text-center" style="color: #000;">Search warrant by ACF</h2>
                        <h6 class="text-center" style="color: #000;">[Section-50(8)(a) of the Wildlife (Protection) Act,1972]</h6>
