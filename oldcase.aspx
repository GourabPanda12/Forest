<%@ Page Language="C#" AutoEventWireup="true" CodeFile="oldcase.aspx.cs" Inherits="oldcase" %>
 ...
 $.ajax({
            ...
            $('#autocomplete').autocomplete({
                source: function (request, response) {
                    $.ajax({
                        type: "POST",
                        url: "oldcase.aspx/GetAutoCompleteData",
    ...
    <div class="col-md-8">
        ...
        <div class="form-group">
            ...
            <a  class="btn btn-outline-secondary" style="padding:7.5px;" href="srchwildlife.aspx"> <i class="fa fa-sign-out"></i></a>
                 <button type="button" class="btn btn-primary" id="openModalBtn" onclick="location.href = 'https://iicaapp.co.in/cmndcrt/allcases.aspx';">View Document</button>
        ...
        <div class="row" id="divpnlx" style="display:none;">
           ...
           <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                <a href="searchwrnt.aspx" class="card-link">
                    <div class="card">
                        <div class="card-body">
                           
                            <p class="card-text text-center">Search warrant by ACF
                ...
                <a href="ckwildlifeofnc.aspx" class="card-link">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text text-center">Checklist For Wildlife Offence
</p>
                        </div>
                    </div>
                </a>
                ...
                <a href="reportingdfo.aspx" class="card-link">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <p class="card-text text-center">Reporting to DFO cum wildlife warden by Range officer regarding registration of case
</p>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                <a href="prlimnarypstmrtmrepo.aspx" class="card-link">
                    <div class="card">
                        <div class="card-body">
                           
                            <p class="card-text text-center">Preliminary post mortem report by the concerned veterinary authority
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                <a href="cwhrepot.aspx" class="card-link">
                    <div class="card">
                        <div class="card-body">
                           
                            <p class="card-text text-center">CWH Report
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                <a href="prosectnrepo.aspx" class="card-link">
                    <div class="card">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                <a href="anyother.aspx" class="card-link">
                    <div class="card">
                        <div class="card-body">
