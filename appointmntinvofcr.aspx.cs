...
public partial class appointmntinvofcr : System.Web.UI.Page
{
    ...
    public static string Insert(List<appodata> jsonDynmxcxx)
    {
    ...
    public static List<appodata> GetAutoCompleteData(string prefix)
    {
        List<appodata> services = new List<appodata>();
