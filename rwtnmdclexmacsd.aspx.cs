...
public partial class rwtnmdclexmacsd : System.Web.UI.Page
{
    ...
    public static string Insert(List<rqwsaccdData> jsonDynmxcxx)
    {
    ...
    public static List<rqwsaccdData> GetAutoCompleteData(string prefix)
    {
        List<rqwsaccdData> services = new List<rqwsaccdData>();
