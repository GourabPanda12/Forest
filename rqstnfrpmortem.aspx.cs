...
public partial class rqstnfrpmortem : System.Web.UI.Page
{
    ...
    public static string Insert(List<pmrtmData> jsonDynmxcxx)
    {
    ...
    public static List<pmrtmData> GetAutoCompleteData(string prefix)
    {
        List<pmrtmData> services = new List<pmrtmData>();
