<%@ Page Language="C#" AutoEventWireup="true" CodeFile="court-case-status.aspx.cs" Inherits="court_case_status" %>
                    ...
                    <div class="col-11 col-sm-10 col-md-10 col-lg-11 col-xl-11 text-center p-0 mt-3 mb-2">
                        <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                            <div class="text-center">
                                ...
                                <h3 id="heading">Court-Case-Status</h3>
                                    <div class="row">
                                        <div class="col-lg-6 mt-3" style="margin: 0 auto;">
                                     <a href="" target="_blank" class="sta">Get Status</a>
                                    </div>
                                    </div>
                            </div>
