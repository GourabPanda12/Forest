...
<body>
                 ...
                 <li class="sub-menu">
                    <a href="javascript:void(0);">sample4<i class="arrow fa fa-angle-right pull-right"></i></a>
                     <ul>
                      ...
                      <li class="sub-menu">
                      <a href="pblcgrvnce.aspx"><i class="fa fa-rocket" aria-hidden="true"></i><span>Offence Information</span></a>
    ...
    <div class="container" style="margin-top:50px;">
        <div class="row" id="paneldiv">
            <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                <a href="forwld.aspx" class="card-link">
                    <div class="card">
                        <span style=""><i class="fa fa-window-restore treex"></i></span>
                        <div class="card-body">
                            <h5 class="card-title text-center">Offence</h5>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                <a href="offline.aspx" class="card-link">
                    <div class="card">
                        <span><i class="fa fa-forumbee treex" aria-hidden="true"></i></span>
                        <div class="card-body">
                            <h5 class="card-title text-center">Schelduled Forms</h5>
                            <p class="card-text text-center">Black Tiger</p>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                 <a href="legal.aspx" class="card-link">
                    <div class="card">
                        <span><i class="fa fa-hourglass-half treex" aria-hidden="true"></i></span>
                        <div class="card-body">
                            <h5 class="card-title text-center">Legal Guidance</h5>
                            <p class="card-text text-center">Black Tiger</p>
                        </div>
                    </div>
                </a>
           ...
           <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                <a href="pblcgrvnce2.aspx" class="card-link">
                    <div class="card">
                        <span><i class="fa fa-rocket treex" aria-hidden="true"></i></span>
                        <div class="card-body">
                            <h5 class="card-title text-center">Offense Information</h5>
                            <p class="card-text text-center">Black Tiger</p>
                        </div>
                    </div>
                </a>
    ...
    <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                <a href="crimercd.aspx" class="card-link">
                    <div class="card">
                        <span><i class="fa fa fa-contao treex" aria-hidden="true"></i></span>
                        <div class="card-body">
                            <h5 class="card-title text-center">Crime Records</h5>
                            <p class="card-text text-center">Black Tiger</p>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                <a href="judgement.aspx" class="card-link">
                    <div class="card">
                          <span><i class="fa fa-bar-chart-o treex" aria-hidden="true"></i></span>
                        <div class="card-body">
                            <h5 class="card-title text-center">Judgements</h5>
                            <p class="card-text text-center">Black Tiger</p>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                <a href="act.aspx" class="card-link">
                    <div class="card">
                           <span><i class="fa fa-certificate treex" aria-hidden="true"></i></span>
                        <div class="card-body">
                            <h5 class="card-title text-center">Act And Rules</h5>
                            <p class="card-text text-center">Black Tiger</p>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                <a href="Userroles.aspx" class="card-link">
                    <div class="card">
                        <span><i class="fa fa-users treex" aria-hidden="true"></i></span>
                        <div class="card-body">
                            <h5 class="card-title text-center">User Access & Privilledges</h5>
                            <p class="card-text text-center">Black Tiger</p>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                <a href="circular-notification.aspx" class="card-link">
                    <div class="card">
                         <span><i class="fa fa-ravelry treex" aria-hidden="true"></i></span>
                        <div class="card-body">
                            <h5 class="card-title text-center">Circular Notification</h5>
                            <p class="card-text text-center">Black Tiger</p>
                        </div>
                    </div>
                </a>
			  ...
			  <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                <a href="range-diary.aspx" class="card-link">
                    <div class="card">
                        <span><i class="fa fa-futbol-o treex" aria-hidden="true"></i></span>
                        <div class="card-body">
                            <h5 class="card-title text-center">Range Diary</h5>
                            <p class="card-text text-center">Black Tiger</p>
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-sm-6 col-md-4 col-lg-4 mb-4" style="display:none;">
                <a href="range-diary.aspx" class="card-link">
                    <div class="card">
                        <span><i class="fa fa-tint treex" aria-hidden="true"></i></span>
                        <div class="card-body">
                            <h5 class="card-title text-center">Range Diary</h5>
                            <p class="card-text text-center">Black Tiger</p>
                        </div>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                <a href="sample-form.aspx" class="card-link">
                    <div class="card">
                         <span><i class="fa fa-fire treex" aria-hidden="true"></i></span>
                        <div class="card-body">
                            <h5 class="card-title text-center">Sample Form</h5>
                            <p class="card-text text-center">Black Tiger</p>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                <a href="estblnk.aspx" class="card-link">
                    <div class="card">
                          <span><i class="fa fa-table treex" aria-hidden="true"></i></span>
                        <div class="card-body">
                            <h5 class="card-title text-center">Establishment</h5>
                            <p class="card-text text-center">Black Tiger</p>
                        </div>
                    </div>
                </a>
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                <a href="accntlnk.aspx" class="card-link">
                    <div class="card">
                          <span><i class="fa fa-envelope treex" aria-hidden="true"></i></span>
                        <div class="card-body">
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                <a href="leaslnk.aspx" class="card-link">
                    <div class="card">
                        <span><i class="fa fa fa-tasks treex" aria-hidden="true"></i></span>
                        <div class="card-body">
                            <h5 class="card-title text-center">Lease and Miscellaneous</h5>
                            <p class="card-text text-center">Black Tiger</p>
                        </div>
                    </div>
                </a>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                <a href="crimercd2.aspx" class="card-link">
                    <div class="card">
                        <span><i class="fa fa fa-tasks treex" aria-hidden="true"></i></span>
                        <div class="card-body">
                            <h5 class="card-title text-center">Crime Record Database</h5>
                            <p class="card-text text-center">Black Tiger</p>
                        </div>
                    </div>
                </a>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
    <a href="log.aspx" class="card-link">
        <div class="card">
            <span><i class="fa fa fa-tasks treex" aria-hidden="true"></i></span>
            <div class="card-body">
                <h5 class="card-title text-center">Log Report</h5>
                <p class="card-text text-center">Black Tiger</p>
            </div>
        </div>
    </a>
