...
public partial class exhibtnfrnsicexmn : System.Web.UI.Page
{
    ...
    public static string Insert(List<xhbtxxData> jsonDynmxcxx)
    {
    ...
    public static List<xhbtxxData> GetAutoCompleteData(string prefix)
    {
        List<xhbtxxData> services = new List<xhbtxxData>();
