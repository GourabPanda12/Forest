<%@ Page Language="C#" AutoEventWireup="true" CodeFile="beforesearch.aspx.cs" Inherits="beforesearch" %>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"
	...
	<title>before Search Protocol</title>
 ...
 <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.5.14/jspdf.plugin.autotable.min.js"></script>
      ...
      <script>
          ...
          function print() {
              ...
              doc.setFont("Times", "Normal");
              doc.text("(to be filled before Form- II is prepared)", 20, 75);
              ...
              posses.forEach((item) => {
                  ...
                  doc.text("possession:-", margin + 5, yPosition);
                  ...
                  wrappedPossession.forEach((line) => {
                      ...
                      doc.text(line, margin + 27, yPosition); // Indent content slightly
                      yPosition += lineHeight;
                  });
              ...
              undertaken.forEach(function (entry) {
                  ...
                  if (entry.idUpload) {
                      ...
                      yPosition += imageHeight + 5; // Move yPosition below the image
                  }
              });
              ...
              doc.save('case-document-beforesearch.pdf');
       ...
       <main>
        ...
        <div class="container-fluid" style="margin-top: 40px;">
            ...
            <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
             ...
             <%--  <p id="heading1">BEFORE SEARCH </p>--%>
                 <h2 class="text-center" id="heading1" style="color: #fff;">BEFORE SEARCH</h2>
             </div>
...
-->
         <p  style="color: #000; font-size: 17px;" class="text-center">(To be filled before Form- II is prepared)</p>
				   
            <P  style="color: #000; font-size: 16px;" class="text-center">Place/s (with GPS co-ordinates & landmark) or Person/s (with full details) to be searched</P>
           ...
           <!--
            ...
            <P style="color: #000; font-size: 16px;" class="text-center">Possession found from the search party before conducting the search of the place or person(as searched by the independent witness infront of accused)</P>
         ...
         <div id="accusedDetail">  </div>
            ...
            <P style="color: #000; font-size: 16px;" class="text-center">Name, Address, Contact, Signature with date of Independent Witnesses/ Others who conducted searchof search party towards satisfaction before actual search is undertaken</P>
            <div class="row mb-3">
              <div class="col-lg-4  col-sm-4 col-xs-4 abc">
