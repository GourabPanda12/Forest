...
public partial class oldcase : System.Web.UI.Page
{
    ...
    public static List<CaseData3> GetAutoCompleteData(string prefix)
    {
        List<CaseData3> services = new List<CaseData3>();
    ...
    public static string[] Getdespp3(string name)
    {
        ...
        using (SqlConnection conn = new SqlConnection())
        {
            ...
            using (SqlCommand cmd = new SqlCommand())
            {
                cmd.CommandText = "select division,dist,city,rangeofcr,remark,date from tbl_newcaseform where casno='"+name+"'";
