<%@ Page Language="C#" AutoEventWireup="true" CodeFile="phtgrphofndrs.aspx.cs" Inherits="phtgrphofndrs" %>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"
 ...
 <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.5.14/jspdf.plugin.autotable.min.js"></script>
	...
	<title>Photographs Of Carcass</title>
   <script type="text/javascript">
       var rqtn = [];
       $(document).ready(function () {
           $('#abcx').on('change', function () {
               const selectedValue = $(this).val();
               let url = '';

               // Determine the URL based on the selected value
               if (selectedValue === "Forest") {
                   url = "phtgrphofndrs.aspx/Getdespx";
               } else if (selectedValue === "Wildlife") {
                   url = "phtgrphofndrs.aspx/Getdesp";
               } else {
                   // Reset the Case No. dropdown if no valid option is selected
                   $('#myDropdown').html('<option value="">Choose Case</option>');
                   return;
               }
               ...
               $.ajax({
                   ...
                   success: function (response) {
                       ...
                       $.each(response.d, function (index, item) {
                           ...
                           $('#myDropdown').append('<option value="' + parts[0] + '">' + parts[1] + '</option>');
                       });

                       // Optional: Initialize Select2 plugin
                       $('#myDropdown').select2({
           ...
           $('.btn-primary').on('click', function (e) {
               ...
               const formData = {
                   chooseOne: $('#abcx').val(),
                   caseNo: $('#myDropdown option:selected').text(),
                   name: $('#name').val(),
                   aliases: $('#aliases').val(),
                   dob: $('#dob').val(),
                   ...
                   identificationMarks: $('#identificationMarks').val(),
                   ...
                   associates: $('#associates').val(),
                   crimeHistory: $('#crimeHistory').val(),
                   modusOperandi: $('#modusOperandi').val(),
                   areaActivities: $('#areaActivities').val(),
                   acquittals: $('#acqu').val(),
                   proclaimedOffenderDetails: $('#acqu1').val(),
                   otherRemarks: $('#acqu2').val(),
               ...
               console.log('Form Data to be Sent:', formData); // Log the data to inspect before sending

               // AJAX request
               $.ajax({
                   url: 'phtgrphofndrs.aspx/SaveFormData', // Replace with your actual backend endpoint
                   method: 'POST',
           ...
           //        localStorage.setItem('rqtnx1', JSON.stringify(rqtn));
           //        localStorage.setItem('hdrsec', "Sec1");
           //        $.ajax({
           //            type: "POST",
       ...
       //    doc.text("Personal File Dossier Of Offender", pdfWidth / 2, topMargin + 15, { align: "center" });
       ...
       //    doc.save('case-document-pht_offndr.pdf');
...
<h2 class="text-center" style="color: #fff;">Personal Dossier Of Offenders</h2>
    ...
    <label for="applicationNumber">Choose One </label>
    <select class="form-control" id="abcx">
...
<div class="form-group">
    <label for="myDropdown">Case No.</label>
    <select id="myDropdown" class="form-control">
        ...
        <div class="form-group">
            <label for="name">Name, Father’s Name, and Address</label>
            <textarea class="form-control" id="name" rows="2" placeholder="Enter full name, father's name and address"></textarea>
        </div>
        <div class="form-group">
            <label for="aliases">Aliases</label>
            <input type="text" class="form-control" id="aliases" placeholder="Enter aliases">
        </div>

        <!-- Section 2 -->
        <div class="section-title">2. Personal Descriptions</div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="hair" placeholder="Enter hair description">
        </div>
        <div class="form-group">
            <label for="eyeColor">Color of Eyes</label>
            <input type="text" class="form-control" id="eyeColor" placeholder="Enter eye color">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="height" placeholder="Enter height in cm or feet/inches">
        </div>
        <div class="form-group">
            <label for="weight">Weight</label>
            <input type="text" class="form-control" id="weight" placeholder="Enter weight in kg or pounds">
        </div>
        <div class="form-group">
            <label for="build">Built</label>
            <input type="text" class="form-control" id="build" placeholder="Enter body build">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="language" placeholder="Enter languages spoken">
        </div>
        <div class="form-group">
            <label for="identificationMarks">Identification Marks</label>
            <textarea class="form-control" id="identificationMarks" rows="2" placeholder="Enter any identification marks"></textarea>
        </div>

        <!-- Section 3 -->
        <div class="section-title">3. Important Personal Information</div>
        <div class="form-group">
            <label for="phoneNumber">Telephone/ Mobile Phone Number</label>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="bankAccount" placeholder="Enter bank account details">
        </div>
        <div class="form-group">
            <label for="adhaar">Adhaar No./Identity Card of EC, India</label>
            <input type="text" class="form-control" id="adhaar" placeholder="Enter Adhaar number or identity card number">
        </div>

        <!-- Section 4 -->
        <div class="section-title">4. Occupation and Associates</div>
        <div class="form-group">
            <label for="occupation">Current/Previous Occupations and List of Properties Owned</label>
            <textarea class="form-control" id="occupation" rows="2" placeholder="Enter occupation details"></textarea>
        </div>
        <div class="form-group">
            <label for="associates">Associates/Relatives and Their Occupations</label>
            <textarea class="form-control" id="associates" rows="2" placeholder="Enter associates or relatives and their occupations"></textarea>
        </div>

        <!-- Section 5 -->
        <div class="section-title">5. Crime History and Modus Operandi</div>
        <div class="form-group">
            <label for="crimeHistory">Crime History and Brief Cases of the Wildlife Case(s) Against Him</label>
            <textarea class="form-control" id="crimeHistory" rows="2" placeholder="Enter crime history"></textarea>
        </div>
        <div class="form-group">
            <label for="modusOperandi">Crime Modus Operandi</label>
            <textarea class="form-control" id="modusOperandi" rows="2" placeholder="Enter crime modus operandi"></textarea>
        </div>

        <!-- Section 6 -->
        <div class="section-title">6. Area of Activities</div>
        <div class="form-group">
            <label for="areaActivities">Area of His Activities</label>
            <textarea class="form-control" id="areaActivities" rows="2" placeholder="Enter area of activities"></textarea>
        </div>

        <!-- Section 7 -->
        <div class="section-title">7. Legal Status and Remarks</div>
        <div class="form-group">
            <label for="acquittals">Previous Acquittals/Convictions</label>
            <textarea class="form-control" id="acqu"></textarea>
            </div>
            
            <div class="section-title">If declared proclaimed offender details</div>
        <div class="form-group">
            <label for="acquittals">f declared proclaimed offender details<s</label>
            <textarea class="form-control" id="acqu1"></textarea>
            </div>
                      <div class="section-title">Any Other Remarks</div>
        <div class="form-group">
            <label for="acquittals">Any Other Remarks</label>
            <textarea class="form-control" id="acqu2"></textarea>
            </div>
