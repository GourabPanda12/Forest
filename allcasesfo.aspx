<%@ Page Language="C#" AutoEventWireup="true" CodeFile="allcasesfo.aspx.cs" Inherits="allcasesfo" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            function OnSuccessddlx33(response) {
                ...
                $.each(response, function (index, item) {
                    for (var i in item) {
                        $('#tcss').append(' <tr><td>' + f + '</td><td>' + item[i].split('*')[0] + '</td><td>0&nbsp;<button type="button" class="btn btn-info">Manage</button></td><td>0&nbsp;<button type="button" class="btn btn-info">Manage</button></td><td>' + item[i].split('*')[1] + '</td><td>' + item[i].split('*')[2] + '</td><td>' + item[i].split('*')[3] + '</td><td>' + item[i].split('*')[4] + '</td><td><button type="button" onclick="fnpdfx()" class="btn btn-primary">Download PDF</button><button type="button" class="btn btn-success">Delete</button><button type="button" class="btn btn-success">Resume</button></td> </tr>');
                        f++;
                    }
