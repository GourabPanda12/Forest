<%@ Page Language="C#" AutoEventWireup="true" CodeFile="disposal.aspx.cs" Inherits="disposal" %>
...
<head>
    ...
    <title>DISPOSAL OF CERTIFICATE CASES</title>
    ...
    <section id="content">
        ...
        <h3 class="sam"><i class="fa fa-paw" aria-hidden="true"></i>&nbsp;BLACK TIGER</h3>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-11 col-sm-10 col-md-10 col-lg-11 col-xl-11 text-center p-0 mt-3 mb-2">
                            <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                                <h2 class="end">Statement Showing The Disposal Of Certificate Cases Of BLACK TIGER Half Yearly Return</h2>
                                    ...
                                    <table class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th colspan="2">No of cases outstanding at the end of the quarter.</th>

                                                <th colspan="2">No of cases instituted during the quarter</th>
                                                <th colspan="2">Total no of  cases outstanding during the quarter </th>

                                                <th colspan="2">No of cases disposed off during the quarter</th>
                                                <th colspan="2">No of cases outstanding for disposal at the end of the quarter</th>
            ...
            <div style="float: left; padding-top: 7px;" class="re">
                <p class="ppl">Old K.L</p>
                <p class="ppl" style="margin-top: -20px;">Regular Contractor</p>
            </div>
