<%@ Page Language="C#" AutoEventWireup="true" CodeFile="form3pdf.aspx.cs" Inherits="form3pdf" %>
    ...
    <script>
        $(document).ready(function () {
            $("#btnGeneratePDF").click(function (event) {
                ...
                $.ajax({
                    type: "POST",
                    url: "GetData.asmx/GetSeizureData",
            ...
            function generatePDF(data) {
               ...
               // doc.text(organizationAddress, pageWidth / 2, headerHeight / 2 + 10, { align: "center" });
                ...
                img.onload = function () {
                    ...
                    doc.addImage(img, 'PNG', 70, 1, 140, 30); // (image, format, x, y, width, height)
                    ...
                    $.each(jsonArray, function (index, obj) {
                        ...
                        $.each(obj, function (key, value) {
                          ...
                          //  y += 10; // Increment y position
                            ...
                            y += 3; // Increase y position by 5 units for the line
                ...
                img.src = 'pdfimages/FORM-II-SEIZURE-LIST_Header.jpg';
