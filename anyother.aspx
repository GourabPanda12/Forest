<%@ Page Language="C#" AutoEventWireup="true" CodeFile="anyother.aspx.cs" Inherits="anyother" %>
    ...
    <script type="text/javascript">
        ...
        function print() {
           ...
           // doc.text('Phone: (123) 456-7890', pageWidth / 2, margin + 95, { align: 'center' });
            ...
            doc.text("CWH Report", pdfWidth / 2, topMargin + 15, { align: "center" });
            ...
            doc.save('case-document-cwhrepot.pdf');
              ...
              <ul>
                 ...
                 <li><a href="deputationoder.aspx">Deputation order of witnesses by concerned authority</a></li>
                  ...
                  <li><a href="aftersearch.aspx">After search protocol</a></li>
                   ...
                   <li><a href="fircopy.aspx">CWH Report</a></li>
...
<h2 class="text-center" style="color: #fff;">Any Other Report</h2>
