﻿<%@ Page Language="C#" AutoEventWireup="true" CodeFile="deputationoder.aspx.cs" Inherits="deputationoder" %>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"
 ...
 <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.5.14/jspdf.plugin.autotable.min.js"></script>
	...
	<title>Deputation Order Of Witness By Concerned Authority</title>
     ...
     <script type="text/javascript">
         ...
         $(document).ready(function () {
             ...
             const request = indexedDB.open('myBlobDatabase', 1);

             request.onupgradeneeded = function (event) {
                 db = event.target.result;
                 db.createObjectStore('blobStore', { keyPath: 'id' });
             };
             ...
             //        $.ajax({
             //            type: "POST",
             //            url: "deputationoder.aspx/GetAutoCompleteData",
         ...
         function sub() {
             ...
             $.ajax({
                 type: "POST",
                 url: "deputationoder.aspx/Insert",
                 data: JSON.stringify({
                     caseno: caseNo,
                     pic: $("#hiden").val(),
                     path: $("#hidden").val()
         ...
         function print() {
             ...
             doc.text("Deputation Order Of Witness By Concerned Authority", pdfWidth / 2, topMargin + 25, { align: "center" });
             ...
             doc.save('case-document-deputation.pdf');
...
<h2 class="text-center" style="color: #fff;">Deputation Order Of Witness By Concerned Authority</h2>
