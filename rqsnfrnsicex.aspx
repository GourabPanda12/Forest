<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rqsnfrnsicex.aspx.cs" Inherits="rqsnfrnsicex" %>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"
	...
	<title>Requisition for Chemical Examination In Concerned Scientific Lab u/s 293 CrPC 1973 </title>
...
<body>
	...
	<main>
         ...
         <div class="container" style="margin-top: 80px;">
            ...
            <h2 class="text-center" style="color: #fff;">Requisition for Chemical Examination In Concerned Scientific Lab u/s 293 CrPC 1973</h2>
             ...
             <form>
                <h5 class="text-center" style="color: #000; margin-top: 40px;">Forwarding Note to the Forensic Science Laboratory/Institute</h5>
                <p class="second-line">(To be submitted along with exhibits for examination)</p>
...
<input type="text" id="txtfir" class="form-control console" placeholder="">
                    ...
                    <div class="col-md-6">
                        <label for="refNumber">Case No. </label>
                ...
                <div class="row ">
                    <div class="col-md-6">
                        <label for="refNumber">Sections of law :</label>
                        <input type="text" class="form-control form-control-custom" id="signature" placeholder="">
                    </div>
                    <div class="col-md-6">
                 ...
                 <div class="form-group form-section">
                     <label for="address">1. Brief facts of the case :</label>
                     <input type="text" class="form-control" id="from" placeholder="">
                     <p style="color: #000;">(Including nature of charge, brief history and any relevant details.)</p>
                 </div>

                 <div class="form-group form-section">
                    <label for="address">2.	List of exhibits/samples enclosed for examination :</label>
                    
                    <table class="mobile-details">
                        <thead>
                            <tr>
                                <th>S.No.</th>
                                <th>Description of the exhibits </th>
                                <th>How,when and by whom found </th>
                                <th>Source of the exhibits </th>
                                <th>Remarks </th>
                            </tr>
                        </thead>
                        <tbody>
                ...
                <div class="form-group form-section">
                    <label for="address">3.	Nature of examinations to be made :</label>
                    <input type="text" class="form-control" id="from" placeholder="">
                </div>
                ...
                <div class="form-group form-section mt-3">
                    <label for="address">Forwarded to the Director :</label>
                    <input type="text" class="form-control" id="from" placeholder="">
                </div>
                <div class="form-group form-section">
                    <label for="address">Forensic Science Laboratory :</label>
                    <input type="text" class="form-control" id="from" placeholder="">
                </div>
                <div class="form-group form-section">
                    <label for="address">Signature :</label>
                    <input type="file" class="form-control" id="from" placeholder="">
                </div>
                <div class="form-group form-section">
                    <label for="address">Name and designation of the forwarding Officer :</label>
                    <input type="text" class="form-control" id="from" placeholder="">
                </div>
                <div class="form-group form-section">
                    <label for="address">Name of the forwarding court, if applicable :</label>
                    <input type="text" class="form-control" id="from" placeholder="">
                </div>
                ...
                <div>
                    <h5 class="text-center" style="color: #000; margin-top: 40px; ;">RECEIPT </h5>
                </div>
                <div class="underline"></div>
                ...
                <div class="form-group form-section">
                    <label for="facts">The </label>
                    <input type="text" class="form-control" id="dateTime" placeholder="">
                </div>
                <h6  style="color: #000;">Forensic Science Laboratory.</h6>
                ...
                <div class="row ">
                    <div class="col-md-6">
                        ...
                        <input type="date" class="form-control form-control-custom" id="signature" placeholder="">
                    </div>
                    <div class="col-md-6">
                ...
                <div>
                    <h6  style="color: #000; margin-top: 40px;">Under Sections of Law : </h6>
                </div>


                 <div class="form-group form-section">
                     <label for="facts">This is to acknowledge the receipt of </label>
                     <textarea class="form-control" id="facts" rows="3" placeholder=""></textarea>
                 </div>
                 <h6  style="color: #000;">in connection with the case referred to above. </h6>
            ...
            <div class="form-group form-section">
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <label for="seal" style="float: right; margin-right: 20px;">Director.</label>
                    </div>
                </div>&nbsp;&nbsp;
                <div class="underline"></div>
             </div>
