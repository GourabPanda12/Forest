...
public partial class fircopy : System.Web.UI.Page
{
    ...
    public static string Insert(List<ServiceData> jsonDynmxcxx)
    {
    ...
    public static List<ServiceData> GetAutoCompleteData(string prefix)
    {
