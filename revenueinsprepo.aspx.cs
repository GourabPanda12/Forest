...
public partial class revenueinsprepo : System.Web.UI.Page
{
    ...
    public static string Insert(List<rvnispData> jsonDynmxcxx)
    {
    ...
    public static List<rvnispData> GetAutoCompleteData(string prefix)
    {
        List<rvnispData> services = new List<rvnispData>();
