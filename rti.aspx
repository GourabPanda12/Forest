<%@ Page Language="C#" AutoEventWireup="true" CodeFile="rti.aspx.cs" Inherits="rti" %>
...
<h2 class="end" style="letter-spacing: 2px;"> RTI</h2>
    ...
    <table class="table table-bordered table-hover">
        <thead>
            <tr>
             ...
             <th rowspan=2>Name of the person requiring the information</th>
             <th rowspan=2>Address of the person

             </th>

              <th rowspan=2>Nature of information</th>


              <th rowspan=2>Whether all formalities have been compiled by the person requiring the information</th>
              <th rowspan=2>Name of the authority by which the information shall be supplied</th>
              <th rowspan=2>Date on which the information shall be supplied</th>
              <th rowspan=2>Date on which the authority/ authorities concerned requested to supply the required information

              </th>

               <th rowspan=2>No & Date of reminder issued</th>
               <th rowspan=2>Date on which the information are received by the PIO from the authority/ authorities concerned</th>
               <th rowspan=2>Date of supply of information to the person concerned requiring the information</th>
               <th rowspan=2>Reasons in brief for not supplying information</th>
