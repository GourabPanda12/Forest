...
public partial class exhibitfrdingcncrninsn : System.Web.UI.Page
{
    ...
    public static string Insert(List<xhbitData> jsonDynmxcxx)
    {
    ...
    public static List<xhbitData> GetAutoCompleteData(string prefix)
    {
        List<xhbitData> services = new List<xhbitData>();
