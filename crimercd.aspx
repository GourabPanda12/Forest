<%@ Page Language="C#" AutoEventWireup="true" CodeFile="crimercd.aspx.cs" Inherits="crimercd" %>
    ...
    <div class="container" style="margin-top:50px;">
        <div class="row" id="paneldiv">
            <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                <a href="phtgrphofndrs.aspx" class="card-link">
                    <div class="card">
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                <a href="dossiervchl.aspx" class="card-link">
                    <div class="card">
            ...
            <div class="col-sm-6 col-md-4 col-lg-4 mb-4">
                 <a href="courtdiry.aspx" class="card-link">
                    <div class="card">
