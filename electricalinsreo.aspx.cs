...
public partial class electricalinsreo : System.Web.UI.Page
{
    ...
    public static string Insert(List<elctinsData> jsonDynmxcxx)
    {
    ...
    public static List<elctinsData> GetAutoCompleteData(string prefix)
    {
        List<elctinsData> services = new List<elctinsData>();
