<%@ Page Language="C#" AutoEventWireup="true" CodeFile="wildlife-database.aspx.cs" Inherits="wildlife_database" %>
...
<head>
    ...
    <title>Wildlife Crime Data Base </title>
...
<h2 class="end">Wildlife Crime Data Base 2023-24 (from 01.04.2023 to till date )</h2>
    ...
    <table class="table table-bordered table-hover">
        <thead>
            <tr>
                ...
                <th>Name of Range</th>
                <th>Case No. & date with Penal Section </th>
                <th>Date of detaction  </th>
                <th>Place of detaction</th>
                <th>Case detacting agency and agency to which case handed over for investigation</th>
                <th>Species Common Name</th>
                <th>Species Scientific Name</th>
                <th>Age & Sex of the Species</th>
                <th>Property recovered (Live animal/Carcass/body parts/armas and immunization/GI wirevehicles/other material etc.(in details) </th>
                <th>Name and address of the accused persons </th>
                <th>Name of the accused arrested</th>
                <th>Name of the accused against whom NBW issued</th>
                <th>Date of forwarding to Court</th>
                <th>Court name & Case (2bcc)No.</th>
                <th>Name of the accused relased on bail with date </th>
                <th>Status of submission of Final PR</th>
                <th>Present status of the case </th>
                <th>Name and Mobile No. of IO of the Case </th>
                <th>Action taken aginst any staff (Departmental staff)</th>
                <th>Brief facts of th case</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>BLACK TIGER</td>
                <td>SadarRange</td>
                <td>13.06.2023 (UD 01/2023-24 of Sadar Range)Under Section 39  of  the Wildlife (Protection) Act, 1972.</td>
                <td>13.06.2023</td>
                <td>Outside of Basiapada-Birsinghgarh RF, Near Basiapada Village ( near old crusher)</td>
                <td>Forest Deptt</td>
                <td>Elephant</td>
                <td>Elephas maximus</td>
                <td>15-20 years /male</td>
                <td>Carcass of a male elephant . tusk=2 nos.(found intact), left tusk=5.350 kg , right tusk=4.900 kg.</td>
                <td>Nil</td>
                <td>Nil</td>
                <td>Nil</td>
                <td>Nil</td>
                <td>Nil</td>
                <td>Nil</td>
                <td>Vide Memo. No. 825 dtd.15.09.2023</td>
                <td>case is dropped as the death was due to disease ( Anthrax)</td>
                <td>Sri Hari Shankar Naik,ACF,I/C-Sadar Range ,Mb. No.8658209266</td>
                <td>Nil</td>
                <td>The elephant was separated from its herd and was under close watch by the  Range staff .Medical assistance was also given by the veterinary officer  but reported dead on 13..6.2023 about 2.30 P.M. Death due to disease.(severe maggot infection in the lower mendable leading up to esophagus.)(ANTHRAX)</td>
            ...
            <tr>
                ...
                <td> BLACK TIGER</td>
                <td>Dhama Range</td>
                <td>14.06.2023 (OR.No.6 of 2023-24)Under Section 9 read with sec2(16)(b) &52  of  the Wildlife (Protection) Act, 1972, punishable u/s 51 of the same Act.</td>
                <td>14.06.2023</td>
                <td>Near Amkuni VSS & TDRF Bhalugard area,Beat/Sec./Range-Dhama,Divn-BLACK TIGER</td>
                <td>Forest Deptt.</td>
                <td>Nil</td>
                <td>Nil</td>
                <td>Nil</td>
                <td>(Illegal Hooking of Electricity ) G.I wire – 2 bdls. Bamboo sticks - 10 nos. Plastic rope- 5 mt. Mobile - 2 nos(keypad) </td>
                <td>1- Jasman Lakra(Age-38 Years)S/o-Late Sudarshan Lakra,vill/P.O- Dakara,P.S- Dhama, Dist-Sambalpur.2-  Bijaya Bag (Age-28 Years),S/o-Sukru Bag,3-  Rakesh Kujur (Age-35 Years)S/o-Late Ishtosh Kujur,both are of Village/PO- Amkuni,P.S- Dhama, Dist-Sambalpur</td>
                <td>All of three accused persons are arrested.</td>
                <td>Nil</td>
                <td>15.06.2023</td>
                <td>Court of the S.D.J.M.,Sambalpur .2(b)cc No. 06 /2023 .</td>
                <td>Nil</td>
                <td>Final PR not submitted</td>
                <td>under investigation</td>
                <td>SDJM, Sambalpur</td>
                <td>Nil</td>
                <td>Dhama Range staff while  conducting  patrolling duty basing on a reliable information near Amkuni VSS & TDRF Bhalugard area detected this case of attempting  hunting by illegal hooking of electricity during and apprehended three nos. of  accused persons.</td>
...
<h3 style="color:#fff;font-weight: 500; font-size: 22px; letter-spacing: 1px; margin-top: 10px;">Abstract</h3>
<div class="table-responsive">
    <table class="table table-bordered table-hover">
        <thead>
            <tr>
                <th>Name of Species /other activities</th>
                <th>Total No.of Offence case booked</th>
                <th>Total No. of person arrested</th>
                <th>Name and total No. of preoperty recovered</th>
                <th>Total No. of final PR submitted</th>
            </tr>
            ...
            <tbody>
                ...
                <tr>
                    <td>Illegal entry to RF area</td>
                    <td>2</td>
                    <td>4</td>
                    <td>G.I wire – 2 bdls. One Country made loaded  Gun, 7 Nos. of handmade lead pellet</td>
                    <td>Nil</td>
                </tr>
