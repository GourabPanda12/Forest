<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ckwildlifeofnc2.aspx.cs" Inherits="ckwildlifeofnc2" %>
 ...
 <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.5.14/jspdf.plugin.autotable.min.js"></script>
    ...
    <script>
        ...
        function print() {
            ...
            doc.text("Checklist For Forest Offence", pdfWidth / 2, topMargin + 15, { align: "center" });
            ...
            const marginLeft = 30;
            const lineHeight = 18;
            const sectionIds = ['#electrocution','#procedures'];
            ...
            doc.save('case-document-ckforestlifeofnc.pdf');
...
<h3 class="sam"><i class="fa fa-tree" aria-hidden="true"></i>&nbsp;Black Tiger</h3>
		...
		<main>
            ...
            <h2 class="text-center" style="color: #fff;">Checklist For Forest Offence</h2>
       ...
       <h6>Choose Offence</h6>
        ...
        <select id="slctofnce" class="form-control">
            ...
            <option value="electrocution">A. General Investigation Procedures</option>
         ...
         <h3 class="text-center" style="color: #fff;">A. General Investigation Procedures:</h3>
             ...
             <div class="row asd d-flex pt-4 pb-4">
                ...
                <div>
                <h5 class="head1" style="color: #000;">1. Verification of Forest Status:</h5>
                 
                <p>
                    <label>
                        <input type="checkbox" name="Forensic" value="Forensic">
                       - Has the relevant Reserve Forest or Forest block notification been included?
                    </label>
                </p>
                     <p>
     <label>
         <input type="checkbox" name="Forensic" value="Forensic">
       - Is the area of the offence verified as per the forest block notification?
     </label>
 </p>
        ...
        <input type="text" id="txtelct" class="form-control">
               ...
               <div>
                 <h5 class="head1" style="color: #000;">2. Seized Material Verification:</h5>

                <p>
                    <label>
                        <input type="checkbox" name="Forensic" value="Forensic">
                          - Is the seized material verified as per the definitions under Section 2 of The Orissa forest act, 1972?
                    </label>
                </p>
        ...
        <p>
            <label>
                <input type="checkbox" name="Forensic" value="Forensic"> 
                 - Are the types and quantities of forest produce recorded?
            </label>
        </p>  
     ...
     <div>
        <h5 class="head1" style="color: #000;">3. Forensic Examination:</h5>

        <p>
            <label>
                <input type="checkbox" name="Forensic" value="Forensic">
                - Have samples from the vehicle (such as timber or other materials(may include wildlife)) been sent to a forensic lab for verification purposes?
            </label>
        </p>
        <p>
            <label>
                <input type="checkbox" name="Forensic" value="Forensic">
                 - Is the forensic report attached?
            </label>
        </p>
      ...
      <div>
        <h5 class="head1" style="color: #000;">4. Section 56 of THE ORISSA FOREST ACT, 1972:</h5>

        <p>
            <label>
                <input type="checkbox" name="Forensic" value="Forensic">
              - Has the seizure been conducted in accordance with Section 56?
            </label>
        </p>
        <p>
            <label>
                <input type="checkbox" name="Forensic" value="Forensic">
                 - Are the proper seizure forms filled out and signed?
            </label>
        </p>
        <p>
            <label>
                <input type="checkbox" name="Forensic" value="Forensic">
                 - Have the procedures for confiscation been complied with?
            </label>
        </p>
           <p>
     <label>
         <input type="checkbox" name="Forensic" value="Forensic">
         - Are the necessary legal documents for confiscation attached to the final PR and forwarding report?
     </label>
 </p>
           <label>Remarks</label>
      ...
      <div>
        <h5 class="head1" style="color: #000;">5. Spot Map:</h5>
        <p>
            <label>
                <input type="checkbox" name="Documentary" value="Documentary"> - Is the location of the offence accurately marked and documented through map?
            </label>
        </p>
        <label>Remarks</label>
     ...
     <div>
        <h5 class="head1" style="color: #000;">6. Independent Witnesses:</h5>
        <p>
            <label>
                <input type="checkbox" name="Documentary" value="Documentary"> - Have statements from independent witnesses been obtained regarding the seizure?
            </label>
        <p>
            <label>
                <input type="checkbox" name="Documentary" value="Documentary"> - Are these statements documented and attached to the final PR and forwarding report?
            </label>
        </p>
        <label>Remarks</label>
    ...
    <div>
        <h5 class="head1" style="color: #000;">7. Photographic Evidence:</h5>
        <p>
            <label>
                <input type="checkbox" name="Material" value="Material"> Have photographs of the offence site and seized materials been taken?
            </label>
        </p>  
         <p>
     <label>
         <input type="checkbox" name="Material" value="Material"> - Are these photographs attached to the investigation report?
     </label>
 </p>  
            <label>Remarks</label>
    ...
    <div>
        <h5 class="head1" style="color: #000;">8. Call details record </h5>
       

        <p>
            <label>
                <input type="checkbox" name="Material" value="Material"> Has legal certificate has been attached alongwith CDR?
            </label>
        </p>  
        <p>
            <label>
                <input type="checkbox" name="Material" value="Material"> Has the CDR analysis checked to connect all the accused location towards the offence?
            </label>
        </p> 
    ...
    <div>
        <h5 class="head1" style="color: #000;">9. Facts from Confession :</h5>
        
        <p>
            <label>
                <input type="checkbox" name="Material" value="Material"> Scene of crime
            </label>
        </p>  
        ...
        <p>
         ...
         <p>
     <label>
         <input type="checkbox" name="Material" value="Material"> Whether fir has been lodged in local ps under arms act,1959
     </label>
 </p>  
 ...
 <p>
     <label>
        ...
        <p>
    <label>
        <input type="checkbox" name="Material" value="Material"> Downward link and upward link has been established from.the Confession statement 
    </label>
</p>
...
<div class="container section"  id="procedures"  style="margin-top: 20px;">
    ...
    <h3 class="text-center" style="color: #fff;">D. Detailed Procedures for Seized Vehicle </h3>
        ...
        <div class="row asd d-flex pt-4 pb-4">
            ...
            <label> <input type="text" id="txtdtlpr" class="form-control"></div>
...
"><i>(Supported image file formats - jpeg/png/jpg)</i></abbr>
                                ...
                                <div class="col-lg-3 col-sm-6 col-xs-6 mt-3">
