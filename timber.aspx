<%@ Page Language="C#" AutoEventWireup="true" CodeFile="timber.aspx.cs" Inherits="timber" %>
...
<head>
    ...
    <title>HY RETURN OF TIMBER</title>
...
<h2 class="end"> Half Yearly progress report on Timber Coupe for the year-2023-24 of BLACK TIGER </h2>
    ...
    <table class="table table-bordered table-hover">
        <thead>
            <tr>
                ...
                <th rowspan=3>Name of the Divn.</th>
                <th rowspan=3>No.of Coupes due for working </th>
                <th rowspan=3>Area of the coupe (inHa.)</th>

                <th rowspan=3>No.of Coupes delivered to OFDC Ltd.</th>
                <th rowspan=3>Area in (Ha.)</th>
                <th rowspan=3>No.of Coupes worked by OFDCLtd.</th>
                <th rowspan=3>Area in (inHa.)</th>

                <th rowspan=3>Name.of coupes Surrendered by OFDC Ltd.</th>
                <th rowspan=3>Reason for surrender if any</th>
                <th rowspan=3>Area in (Ha.)</th>
                <th rowspan=3>Reasons for surrender </th>



                <th colspan=8>Coupe wise production of timber and firewood</th>



                <th colspan=4>Mandays Generated</th>
            ...
            <tr>
              <th rowspan=2>Name of the Coupe</th>
              <th rowspan=2>No.of trees marked</th>
              <th rowspan=2>No.of trees felled</th>
              <th rowspan=2>Unit</th>
              <th colspan=2>Timber in (Cum)</th>
              <th colspan=2>Firewood in Stack</th>
              <th colspan=2>During the  month</th>
              <th colspan=2> Progressive   total</th>
