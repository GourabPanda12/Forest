<%@ Page Language="C#" AutoEventWireup="true" CodeFile="form8pdf.aspx.cs" Inherits="form8pdf" %>
    ...
    <script>
        $(document).ready(function () {
            $("#btnGeneratePDF").click(function (event) {
                ...
                $.ajax({
                    type: "POST",
                    url: "GetData.asmx/Additionalinfo",
               ...
               // var img = new Image();
                ...
                //    ];
                    ...
                    img2.onload = function () {
                        ...
                        doc.addImage(img2, 'PNG', 10, 1, 280, 220); // Adjust position as needed
                        ...
                        img3.onload = function () {
                            ...
                            doc.addImage(img3, 'PNG', 10, 1, 280, 220); // Adjust position as needed
                            ...
                            img6.onload = function () {
                                ...
                                doc.addImage(img6, 'PNG', 10, 1, 280, 220); // Adjust position as needed
                              ...
                              //  doc.save('example.pdf');
                                ...
                                img7.onload = function () {
                                    ...
                                    yPosition2 = 20;
                                    // Add third image below the second image
                                    doc.addImage(img7, 'PNG', 10, 1, 280, 220); // Adjust position as needed
                                ...
                                img7.src = 'pdfimages/ADDITIONAL INFORMATION ON PR FORM_page-0004.jpg';

                            };
                            img6.src = 'pdfimages/ADDITIONAL INFORMATION ON PR FORM_page-0003.jpg';
                        };

                        img3.src = 'pdfimages/ADDITIONAL INFORMATION ON PR FORM_page-0002.jpg';
                    };

                    img2.src = 'pdfimages/ADDITIONAL INFORMATION ON PR FORM_page-0001.jpg';
            ...
            //        doc.save('example.pdf');
            //    };
            //    img.src = 'pdfimages/additioninfo.jpg';
