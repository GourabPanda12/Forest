...
public partial class rqsnchemex : System.Web.UI.Page
{
    ...
    public static string Insert(List<chemxData> jsonDynmxcxx)
    {
    ...
    public static List<chemxData> GetAutoCompleteData(string prefix)
    {
        List<chemxData> services = new List<chemxData>();
