...
public partial class cdrepo65b : System.Web.UI.Page
{
    ...
    public static string Insert(List<cdr65Data> jsonDynmxcxx)
    {
    ...
    public static List<cdr65Data> GetAutoCompleteData(string prefix)
    {
        List<cdr65Data> services = new List<cdr65Data>();
