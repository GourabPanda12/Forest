        ...
        $('#txtbrf').on('change', function () {
            ...
            if (file) {
                ...
                reader.onload = function (e) {
                    ...
                    $('#Hidden1').val(base64Data);   // Base64 data
    ...
    formData33.push(formSection);
         ...
         //   yPosition += 10;
          ...
          //  yPosition += 10; // Move down after the heading
            ...
            // Retrieve the selected file from the file input for Officer's signature
            var fileInputx = document.getElementById('txtofcrsign');
            var filex = fileInputx.files[0];
            var base64Imagex ;
            seizuremark.forEach(function (entry, index) {
                if (yPosition + imageHeight > 280) { // Check for page overflow
                    doc.addPage(); // Add a new page
            ...
            //doc.setFontSize(13);
            //doc.setFont("times", "bold");
            //doc.text("FORM - II", 20, yPosition);
            //yPosition += 10;



            //doc.setFont("times", "normal");
            //doc.text("Landmark Place of seizure", 20, yPosition);

            //doc.setFont("times", "bold");
            //doc.setFontSize(10);

            //// Get the landmark text and split it for proper wrapping
            //const landmarkText = $('#txtlndmrksz').val();
            //const splitLandmarkText = doc.splitTextToSize(landmarkText, 100); // 100 is max width

            //// Calculate total height needed for the text
            //const textHeight = splitLandmarkText.length * 6; // 7 points per line

            //// Check if we need a new page
            //if (yPosition + textHeight > 280) { // 280 is the page height limit
            //    doc.addPage();
            //    yPosition = 20;
            //}

            //// Add the text with proper wrapping
            //doc.text(splitLandmarkText, 90, yPosition, {
            //    align: "justify",
            //    maxWidth: 100,
            //    lineHeightFactor: 1.5
            //});
            ...
            //doc.setFontSize(10);
            //doc.setFont("times", "normal");
            //doc.text("GPS co-ordinates", 20, yPosition);

            //doc.setFontSize(10);
            //doc.setFont("times", "bold");
            //const gpsText = $('#txtgps').val();
            //const splitGpsText = doc.splitTextToSize(gpsText, 100);
            //const gpsHeight = splitGpsText.length * 6;

            //if (yPosition + gpsHeight > 280) {
            //    doc.addPage();
            //    yPosition = 20;
            //}
            //doc.text(splitGpsText, 90, yPosition, {
            //    align: "justify",
            //    maxWidth: 100,
            //    lineHeightFactor: 1.5
            //});
            ...
            //doc.setFontSize(10);
            //doc.setFont("times", "bold");
            //const timeText = $('#txtme').val();
            //const splitTimeText = doc.splitTextToSize(timeText, 100);
            //const timeHeight = splitTimeText.length * 6;

            //if (yPosition + timeHeight > 280) {
            //    doc.addPage();
            //    yPosition = 20;
            //}
            //doc.text(splitTimeText, 90, yPosition, {
            //    align: "justify",
            //    maxWidth: 100,
            //    lineHeightFactor: 1.5
            //});
            //yPosition += timeHeight;

            //// Reasons for seizure section
            //if (yPosition > 280) {
            //    doc.addPage();
            //    yPosition = 20;
            //}
            //doc.setFontSize(10);
            //doc.setFont("times", "normal");
            //doc.text("Reasons for seizure", 20, yPosition);

            //doc.setFontSize(10);
            //doc.setFont("times", "bold");
            //const reasonsText = $('#txtrszre').val();
            //const splitReasonsText = doc.splitTextToSize(reasonsText, 100);
            //const reasonsHeight = splitReasonsText.length * 6;

            //if (yPosition + reasonsHeight > 280) {
            //    doc.addPage();
            //    yPosition = 20;
            //}
            //doc.text(splitReasonsText, 90, yPosition, {
            //    align: "justify",
            //    maxWidth: 100,
            //    lineHeightFactor: 1.5
            //});
            //yPosition += reasonsHeight ;
            //doc.setFontSize(13);
            //doc.setFont("times", "bold");
            ...
            //doc.setFontSize(10);
            //doc.setFont("times", "normal");
            //doc.text("Before Search Protocol No: ........................      Date: .................................       Time: .......................", 20,yPosition);
            //doc.setFontSize(10);
            //doc.setFont("times", "bold");
            //doc.text($('#txtbfresrch').val(), 60, yPosition-1); 
            //doc.text($('#txtdtx').val(), 98, yPosition-1);
            //doc.text($('#txtime').val(), 146, yPosition-1);
            //yPosition += 10;
            ...
            //doc.setFontSize(10);
            //doc.setFont("times", "normal");
            //doc.text("After Search Protocol No: .......................      Date: .................................       Time: .......................", 20, yPosition);
            //doc.setFontSize(10);
            //doc.setFont("times", "bold");
            //doc.text($('#txtatersrch').val(), 60, yPosition-1);
            //doc.text($('#txtdtxx').val(), 98, yPosition-1);
            //doc.text($('#txtmex').val(), 142, yPosition-1);
            //yPosition += 10;
            ...
            //doc.setFontSize(10);
            //doc.setFont("times", "normal");
            //doc.text("Form-i no: ........................      Date: .................................       Time: .......................", 20, yPosition);
            //doc.setFontSize(10);
            //doc.setFont("times", "bold");
            //doc.text($('#txtfomo').val(), 38, yPosition - 1);
            //doc.text($('#txtdty').val(), 75, yPosition - 1);
            //doc.text($('#txtimex').val(), 125, yPosition - 1);
            //yPosition += 10;
            ...
            idcopies.forEach((entry, index) => {
                ...
                doc.addImage(entry.copies, 'JPEG', 90, yPosition, imageWidth, imageHeight);
                yPosition += imageHeight + 5; // Add spacing after image
            });
            ...
            $("#viewData .data-container .input-container").each(function (index) {
                ...
                yPosition += totalHeight + 3; // Add spacing after entry
            });

            // Handle final image if present
            const imgElement = $("#viewData img").first();
            ...
            $("#viewDatax .data-container .input-container").each(function (index) {
                const inputValue = $(this).find("input").val();
                const parts = inputValue.split(":");
                const header = parts[0] + ":";
                const value = parts[1] ? parts[1].trim() : "No Value";
            ...
            // Handle image for first section
            const imgElementx = $("#viewDatax img").first();
            if (imgElementx.length > 0) {
                const imgSrc = imgElementx.attr("src");
                if (imgSrc) {
                    const imageHeight = 15;
                    const imageWidth = 50;
            ...
            $("#viewDatay .data-container .input-container").each(function (index) {
                const inputValue = $(this).find("input").val();
                const parts = inputValue.split(":");
                const header = parts[0] + ":";
                const value = parts[1] ? parts[1].trim() : "No Value";
            ...
            // Handle image for second section
            const imgElementy = $("#viewDatay img").first();
            if (imgElementy.length > 0) {
                const imgSrc = imgElementy.attr("src");
                if (imgSrc) {
                    const imageHeight = 15;
                    const imageWidth = 50;
            ...
            rqtn.forEach(item => {
              ...
              //  yPosition = 100; // Increase spacing between text and image
