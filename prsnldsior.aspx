<%@ Page Language="C#" AutoEventWireup="true" CodeFile="prsnldsior.aspx.cs" Inherits="prsnldsior" %>
...
<body>
  ...
  <aside id="sidebar">
        ...
        <div class="container-fluid" style="margin-top: 40px;">
            ...
            <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
             <div class="text-center">
               ...
               <h3 id="heading">PersonalFile(Dossier)of Offender</h3>

               <div class="row">					
                <div class="col-md-12 fr">
                    <h3 id="heading">Phatograph</h3>
                    <input type="file" id=""  class="form-control console" placeholder="" style="width: 28%; margin: 0 auto;">	
                </div>
            </div>
    ...
    <div class="col-md-12 fr">
        <label class="lebl">1. Name,Father’s Name and Address</label>
    ...
    <div class="row">
        ...
        <div class="col-md-12 fr">
            <label class="lebl">2. Aliases</label>
            <input type="text" id=""  class="form-control console" placeholder="">	
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12 fr">
            <label class="lebl">3.Personal Descriptions</label>        </div>
    </div>
    <div class="row">
											
        <div class="col-md-12 frs">
            <label class="lebl">Date of Birth/age</label>
            <input type="date" id=""  class="form-control console" placeholder="">	
        </div>
    </div>
    <div class="row">
											
        <div class="col-md-12 frs">
            <label class="lebl">Place of Birth</label>
            <input type="text" id=""  class="form-control console" placeholder="">	
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-12 frs">
            <label class="lebl">Colour of eyes</label>
            <input type="text" id=""  class="form-control console" placeholder="">	
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-12 frs">
            <label class="lebl">Complexion</label>
            <input type="text" id=""  class="form-control console" placeholder="">	
        </div>
    </div>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="col-md-12 frs">
            <label class="lebl">Citizenship</label>
            <input type="text" id=""  class="form-control console" placeholder="">	
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-12 frs">
            <label class="lebl">Language</label>
            <input type="text" id=""  class="form-control console" placeholder="">	
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-12 frs">
            <label class="lebl">Identification marks</label>
            <input type="text" id=""  class="form-control console" placeholder="">	
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-12 fr">
            <label class="lebl">4.Important Personal Information</label>
    ...
    <div class="row">
        ...
        <div class="col-md-12 frs">
            <label class="lebl">Telephone/mobilephone number</label>
            <input type="number" id=""  class="form-control console" placeholder="">	
        </div>
    </div>
    <div class="row">
											
        <div class="col-md-12 frs">
            <label class="lebl">e-mail address</label>
            <input type="email" id=""  class="form-control console" placeholder="">	
        </div>
    </div>
    <div class="row">
											
        <div class="col-md-12 frs">
            <label class="lebl">Passport number</label>
            <input type="text" id=""  class="form-control console" placeholder="">	
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-12 frs">
            <label class="lebl">Bank account details</label>
            <input type="text" id=""  class="form-control console" placeholder="">	
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-md-12 frs">
            <label class="lebl">Adhaar No./Identity Card of EC, India</label>
            <input type="text" id=""  class="form-control console" placeholder="">	
        </div>
    </div>
        <div class="row">							
            <div class="col-md-12 fr">
                <label class="lebl" >5.Current/Previous occupations and list of properties owned</label>
                <input type="text" id=""  class="form-control console" placeholder="">	
        ...
        <div class="row">							
            <div class="col-md-12 fr">
                <label class="lebl">6.Associates/Relatives and theiroccupations</label>
                <input type="text" id=""  class="form-control console" placeholder="">	
        ...
        <div class="row">							
            <div class="col-md-12 fr">
                <label class="lebl">7.Crime history and brief cases of the wildlife case(s) against him</label>
                <input type="text" id=""  class="form-control console" placeholder="">	
        ...
        <div class="row">							
            <div class="col-md-12 fr">
                <label class="lebl" >8.Crime modus operandi</label>
                <input type="text" id=""  class="form-control console" placeholder="">	
        ...
        <div class="row">							
            <div class="col-md-12 fr">
                <label class="lebl">9.Area of his activities</label>
                <input type="text" id=""  class="form-control console" placeholder="">	
        ...
        <div class="row">							
            <div class="col-md-12 fr">
                <label class="lebl" >10.Previous Acquittals/convictions</label>
                <input type="text" id=""  class="form-control console" placeholder="">	
        ...
        <div class="row">							
            <div class="col-md-12 fr">
                <label class="lebl">11.If declared Proclaimed Offender,details</label>
                <input type="text" id=""  class="form-control console" placeholder="">	
        ...
        <div class="row">							
            <div class="col-md-12 fr">
                <label class="lebl" >12.Any other remarks</label>
                <input type="text" id=""  class="form-control console" placeholder="">	
