<%@ Page Language="C#" AutoEventWireup="true" CodeFile="compoundorderpdf.aspx.cs" Inherits="compoundorderpdf" %>
    ...
    <script>
        $(document).ready(function () {
            $("#btnGeneratePDF").click(function (event) {
                ...
                $.ajax({
                    type: "POST",
                    url: "GetData.asmx/GetCompoundodr",
            ...
            function generatePDF(data) {
                ...
                img.onload = function () {
                    ...
                    img2.onload = function () {
                        ...
                        doc.addImage(img2, 'PNG', 50, 65, 220, 83); // Adjust position as needed
                        ...
                        img3.onload = function () {
                            ...
                            doc.addImage(img3, 'PNG', 50, yPosition2, 220, 145); // Adjust position as needed
                        ...
                        img3.src = 'pdfimages/compnd_ordr2.jpg';
                    };

                    img2.src = 'pdfimages/compnd_ordr1.jpg';




                };
                img.src = 'pdfimages/copndngorder.jpg';
