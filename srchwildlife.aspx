<%@ Page Language="C#" AutoEventWireup="true" CodeFile="srchwildlife.aspx.cs" Inherits="srchwildlife" %>
    ...
    <div class="container" style="margin-top:50px;">
        <div class="row">
            ...
            <div class="col-sm-4 col-md-4 col-lg-4 mb-4">
                <a href="oldcase.aspx" class="card-link">
                    <div class="card">
                        <div class="card-body">
			  ...
			  <div class="col-sm-4 col-md-4 col-lg-4 mb-4">
                <a href="newcase.aspx" class="card-link">
                    <div class="card">
                        <div class="card-body">
            ...
            <div class="col-sm-4 col-md-4 col-lg-4 mb-4">
                <a href="https://msksoftware.co.in/forestdoc/allcases.aspx" class="card-link">
                    <div class="card">
                        <div class="card-body">
