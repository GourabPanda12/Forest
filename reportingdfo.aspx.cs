...
public partial class reportingdfo : System.Web.UI.Page
{
    ...
    public static string Insert(List<RepoData> jsonDynmxcxx)
    {
    ...
    public static List<RepoData> GetAutoCompleteData(string prefix)
    {
        List<RepoData> services = new List<RepoData>();
