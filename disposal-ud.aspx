<%@ Page Language="C#" AutoEventWireup="true" CodeFile="disposal-ud.aspx.cs" Inherits="disposal_ud" %>
...
<head>
    ...
    <title>HYPROGRESS REPORT ON DISPOSAL OF SEIZED PRODUCE (UD)</title>
...
<h2 class="end">HALF YEARLY PROGRESS REPORT ON DISPOSAL OF SEIZED PRODUCE FOR  SEPTEMBER-2023 (FROM 01.04.2023 TO 30.09.2023) RELATING TO UD CASES. </h2>
...
<div class="table-responsive">
    <table class="table table-bordered table-hover">
        ...
        <thead>
            <tr>
                <th rowspan="2">Name of items Forest Produce</th>
                <th rowspan="2">Stock of forest produce seized at the beginning of the Halfyear</th>
                <th rowspan="2">Quantity of forest produce seized during the Halfyear</th>
                <th rowspan="2">Total stock of forest produce </th>
                <th rowspan="2">Deptt use</th>
                <th rowspan="2">Delivery of OFDC/ DFO (KL)</th>
                <th rowspan="2">Total</th>
                <th rowspan="2">Balance stock to be disposed off</th>
                <th colspan="3">Progressive total upto the end of the Halfyear</th>


                </tr>

                <tr>
                    <th>Total qnty. Disposed off</th>
                    <th>Total amount accured</th>
                    <th>Total amount deposited in Rs.</th>
                </tr>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Sandal wood  (Stumps) weight in K.G</td>
                        <td>109.67</td>
                        <td>0</td>
                        <td>109.67</td>
                        <td>0</td>
