<%@ Page Language="C#" AutoEventWireup="true" CodeFile="spotmapcrscene.aspx.cs" Inherits="spotmapcrscene" %>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"
	...
	<title>Spot Map Of Crime Scene</title>
...
<h5 class="text-center" style="color: #fff;">Spot Map Of Crime Scene(along with Ri Inspection report,Notification Of Sanctuary national park & notification of RI BLOCK Included In THe sanctuary national park notification)</h5>
                      ...
                      <div class="col-md-10  col-12 mx- auto offset-md-1">
                        ...
                        <div class="login-form">
                          ...
                          <div class="row asd d-flex">
                             ...
                             <button class="btnx mt-2 mb-2" type="button" onclick="sub()" >Submit</button>
