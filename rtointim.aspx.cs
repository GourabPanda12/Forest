...
public partial class rtointim : System.Web.UI.Page
{
    ...
    public static string Insert(List<ReqDatax1intm> jsonDynmxcxx)
    {
    ...
    public static string SavePdf(string pdfData, string caseNo, string pageName)
    {
        try
        {
            ...
            string ftpFolder = "ftp://sambalpurforestdivision.iicaapp.co.in/httpdocs/cmndcrt/";
            //   string ftpFolder = "ftp://iicaapp.co.in/httpdocs/cmndcrt/";
            //if (path != null && path != string.Empty)
            //{
