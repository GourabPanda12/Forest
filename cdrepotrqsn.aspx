<%@ Page Language="C#" AutoEventWireup="true" CodeFile="cdrepotrqsn.aspx.cs" Inherits="cdrepotrqsn" %>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"
 ...
 <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.5.14/jspdf.plugin.autotable.min.js"></script>
	...
	<title>CDR report requisition letter to RCCF concerned</title>
 ...
 <script type="text/javascript">
     ...
     $(document).ready(function () {
         ...
         $('#txtcno').autocomplete({
             source: function (request, response) {
                 $.ajax({
                     type: "POST",
                     url: "bailacsed.aspx/GetAutoCompleteData",
     ...
     function print() {
      ...
      //   doc.text('Phone: (123) 456-7890', pageWidth / 2, margin + 95, { align: 'center' });
         ...
         doc.text("CDR report requisition letter to RCCF concerned", pdfWidth / 2, topMargin + 25, { align: "center" });
         ...
         doc.save('case-document-cdrepotrqsn.pdf');
...
<h2 class="text-center" style="color: #fff;">CDR report requisition letter to RCCF concerned</h2>
                        ...
                        <div class="login-form">
                          ...
                          <input type="text" id="txtcno" class="form-control console" placeholder="">
                                  ...
                                  <div class="col-lg-12  col-sm-12 col-xs-12 abc">
                                      ...
                                      <input type="text" id="txtfir" class="form-control console d-none" placeholder="">
