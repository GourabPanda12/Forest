...
public partial class frnscexmnrepo : System.Web.UI.Page
{
    ...
    public static string Insert(List<fornscData> jsonDynmxcxx)
    {
    ...
    public static List<fornscData> GetAutoCompleteData(string prefix)
    {
        List<fornscData> services = new List<fornscData>();
