﻿<%@ Page Language="C#" AutoEventWireup="true" CodeFile="crimedtlspotmp.aspx.cs" Inherits="crimedtlspotmp" %>
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css"
 ...
 <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.5.14/jspdf.plugin.autotable.min.js"></script>
	...
	<title>Crime Details Form along with Spot map (along with RI inspection report/joint verification report, Notification of sanctuary/ national park & notification of RF BLOCK included in the sanctuary/national park notification)</title>
    ...
    <script type="text/javascript">
        ...
        function print() {
            ...
            doc.text("Crime Details Form along with Spot map (along with \n"+
                     " RI inspection report / joint verification report, Notification of  \n"+
                     "sanctuary / national park & notification of RF BLOCK included  \n"+
                    "in the sanctuary / national park notification)", pdfWidth / 2, topMargin + 25, { align: "center" });

            // Set initial y position below the gradient header
            let yPosition = topMargin + gradientHeight + 55;
            doc.setFontSize(12);
            ...
            doc.save('case-document-crimedtlspotmp.pdf');
              ...
              <ul>
                 ...
                 <li><a href="deputationoder.aspx">Deputation order of witnesses by concerned authority</a></li>
                  ...
                  <li><a href="aftersearch.aspx">After search protocol</a></li>
                   ...
                   <li><a href="fircopy.aspx">Crime Details Form along with Spot map (along with RI inspection report/joint verification report, Notification of sanctuary/ national park & notification of RF BLOCK included in the sanctuary/national park notification)</a></li>
...
<h2 class="text-center" style="color: #fff;">Crime Details Form along with Spot map (along with RI inspection report/joint verification report, Notification of sanctuary/ national park & notification of RF BLOCK included in the sanctuary/national park notification)</h2>
