<%@ Page Language="C#" AutoEventWireup="true" CodeFile="salvage.aspx.cs" Inherits="salvage" %>
...
<h2 class="end">Half Yearly  Report On Salvage Operation Of BLACK TIGER </h2>
    ...
    <table class="table table-bordered table-hover">
        <thead>
            <tr>
             ...
             <th colspan=3>Quantity of  timber & Salvage(in Cum.)</th>

             <th colspan=3>Quantity of Firewood  Salvaged in stack (Size 12x'3'x3')</th>
             <th colspan=3>Salvage of poles in Nos.</th>

               <th colspan=3>Quantity of Timber delivered to O.F.D.C.Ltd./disposal(in Cum.)</th>
             <th colspan=3>Quantity of Firewood delivered to O.F.D.C.Ltd./disposal (in Stack.)</th>

               <th colspan=3>Quantity of Poles delivered to O.F.D.C.Ltd./disposal(in Nos..)</th>
               <th colspan=3>Closing Balance of the last quarter </th>
