<%@ Page Language="C#" AutoEventWireup="true" CodeFile="forwld.aspx.cs" Inherits="forwld" %>
...
<body>
    ...
    <form id="form1" runat="server">
      ...
      <aside id="sidebar" style="scrollbar-width: auto!important; display:none;">
        <!--
            <li>
            ...
            <div id="leftside-navigation" class="nano" style="display:none;">
    ...
    <div class="container" style="margin-top:50px;">
        <div class="row">
            ...
            <div class="col-sm-6 col-md-6 col-lg-6 mb-4">
                <a href="srchwildlife.aspx" class="card-link">
                    <div class="card">
                        <div class="card-body">
			  ...
			  <div class="col-sm-6 col-md-6 col-lg-6 mb-4">
                <a href="srchforest.aspx" class="card-link">
                    <div class="card">
                        <div class="card-body">
