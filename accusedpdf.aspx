<%@ Page Language="C#" AutoEventWireup="true" CodeFile="accusedpdf.aspx.cs" Inherits="accusedpdf" %>
        ...
        $(document).ready(function () {
            ...
            function generatePDF(data) {
                ...
                img.onload = function () {
                    ...
                    doc.addImage(img, 'PNG', 60, 1, 160, 35); // (image, format, x, y, width, height)
                    ...
                    img2.onload = function () {
                       ...
                       // yPosition2 = 20;
                        ...
                        doc.addImage(img2, 'PNG', 50, 65, 190, 95); // Adjust position as needed
                        ...
                        $.each(jsonArray, function (index, obj) {
                            ...
                            $.each(obj, function (key, value) {
                                if (inc == 3) {
                                    doc.text(80,69, value);
                                    doc.setFont("helvetica", "bold");
                                    doc.setFontSize(12); 
                                    y += 10;
                                }
                                if (inc == 6) {
                                    doc.text(110,86, value);
                                    doc.setFont("helvetica", "bold");
                                    doc.setFontSize(12); 
                                    y += 10;
                                }
                                if (inc == 4) {
                                    doc.text(110, 92, value);
                                    doc.setFont("helvetica", "bold");
                                    doc.setFontSize(12); 
                                    y += 10;
                                }
                                ...
                                if (inc == 7) {
                                    doc.text(100, 117, value);
                                    doc.setFont("helvetica", "bold");
                                    doc.setFontSize(12); 
                                    y += 10;
                                }
                                if (inc == 8) {
                                    doc.text(140, 117, value);
                                    doc.setFont("helvetica", "bold");
                                    doc.setFontSize(12); 
                                    y += 10;
                                }
                                ...
                                if (inc == 23) {
                                    doc.text(120, 121, value);
                                    doc.setFont("helvetica", "bold");
                                    doc.setFontSize(12); 
                                    y += 10;
                                }
                                if (inc == 25) {
                                    doc.text(187, 151, value);
                                    doc.setFont("helvetica", "bold");
                                    doc.setFontSize(12); 
                                    y += 10;
                                }
                                ...
                                if (inc == 15) {
                                    doc.text(100, 129, value);
                                    doc.setFont("helvetica", "bold");
                                    y += 10;
                                }
                                ////if (inc == 23) {
                                ////    doc.text(100, 142, value);
                                ////    doc.setFont("helvetica", "bold");
                                ////    y += 10;
                                ////}
                                ...
                                if (inc == 26) {
                                    doc.text(30, 157, value);
                                    doc.setFont("helvetica", "bold");
                                    y += 10;
                                }
                                if (inc == 27) {
                                    doc.text(100, 157, value);
                                    doc.setFont("helvetica", "bold");
                                    y += 10;
                                }
                                if (inc == 28) {
                                    doc.text(140, 157, value);
                                    doc.setFont("helvetica", "bold");
                                    y += 10;
                                }
                        ...
                        img3.onload = function () {
                            ...
                            doc.addImage(img3, 'PNG', 50, yPosition2, 190, 125); // Adjust position as needed
                           ...
                           // doc.save('example.pdf');
                            ...
                            img6.onload = function () {
                                doc.addPage(); // Add new page if needed
                                yPosition2 = 20;
                                // Add third image below the second image
                                doc.addImage(img6, 'PNG', 50, yPosition2, 190, 150); // Adjust position as needed

                                // Save the PDF after all images and associated text have been added  AFTER SEARCH PROTOCOL_page-0001 (5)
                                doc.save('example.pdf');



                            };
                            img6.src = 'pdfimages/acused3.jpg';
                        };

                        img3.src = 'pdfimages/acused2.jpg';
                    };

                    img2.src = 'pdfimages/acused1.jpg';


                    //if (yPosition2 > doc.internal.pageSize.height - 10) {
                      // Reset y position
                   // }

                };

                img.src = 'pdfimages/atacsed.jpg';
