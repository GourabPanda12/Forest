    ...
    <title>Final PR Report</title>
      ...
      <script>
          ...
          function sub() {
              ...
              var divisn = $("#txtdiv").val();
              var dt = $("#txtdtd").val();
              var offncrpt = $("#txtfrno").val();
              var range = $("#txtrng").val();
              var dtofdtctn = $("#txtdtctn").val();
              var pocrnce = $("#txtpoc").val();
              var hrdtctn = $("#txthrdtn").val();
              var whmdtct = $("#txtbwdtcted").val();
              var anm = $("#txtacnm").val();
              var ftnm = $("#txtfnm").val();
              var village = $("#txtvil").val();
              var thana = $("#txthana").val();
              var dist = $("#txtdist").val();
              var divson = $("#txtdvsn").val();
              var offcrptno = $("#txtofrpt").val();
              var dated = $("#txtdted").val();
              var rvnestrnge = $("#txtrvnrng").val();
              var memono = $("#txtmemo").val();
              var dtd = $("#txtdated").val();
              var dfoinchrge = $("#txtdfchrg").val();
              var divisnx = $("#txtdvnm").val();
              var memonumber = $("#txtmem").val();
              var dat = $("#txtd").val();
              var dfochrg = $("#txtdfchrgx").val();
              var divisnd = $("#txtdvnmx").val();
              ...
              finalist.push({
                  ...
                  offcrptno: offcrptno,
                  dated: dated,
                  rvnestrnge: rvnestrnge,
                  memono: memono,
                  dtd: dtd,
                  dfoinchrge: dfoinchrge,
                  divisnx: divisnx,
              ...
              $.ajax({
                  type: "POST",
                  url: "final.aspx/Insert",
                  data: "{finalist:" + JSON.stringify(finalist) + "}",
                    ...
                    <div class="col-11 col-sm-10 col-md-10 col-lg-11 col-xl-11 text-center p-0 mt-3 mb-2">
                        <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                            <div class="text-center">
                                <p id="heading1">FORM (VII)</p>

                                <p id="heading1">[VIDE RULE 1]</p>
...
<input type="text" id="txtcno" class="form-control console" placeholder="">
                                                            ...
                                                            <input type="text" id="txtdiv" class="form-control console"
                                                                placeholder="">
                                                            ...
                                                            <input type="number" id="txtfrno" class="form-control console"
                                                                placeholder="">

                                                            <label class="lebl">Date Of Detection</label>

                                                            <input type="date" id="txtdtctn" class="form-control console"
                                                                placeholder="">
                                                              <label class="lebl">Time Of Detection</label>
                                                             <input type="time" id="txthrdtn" class="form-control console"
                                                                placeholder="">
...
<input type="text" id="txtfir" class="form-control console" placeholder="">
                                                            ...
                                                            <input type="date" id="txtdtd" class="form-control console"
                                                                placeholder="">

                                                            <label class="lebl">Range</label>

                                                            <input type="text" id="txtrng" class="form-control console"
                                                                placeholder="">

                                                            <label class="lebl">Place Of Occurrence</label>

                                                            <input type="text" id="txtpoc" class="form-control console"
                                                                placeholder="">

                                                        </div>

                                                        <div class="col-lg-12 col-sm-12 col-xs-12 abc">
                                                            <label class="lebl">By Whom Detected</label>

                                                            <input type="text" id="txtbwdtcted" class="form-control console"
                                                                placeholder="">
                                                        </div>
                            ...
                            <div class="text-center">
                                <p id="heading1">REFERENCE TO SECTIONS OF THE ORISSA FOREST ACT
                                    AND INDIAN PENAL CODE

                                </p>

                                <p id="heading1">[To be filled in by the Divisional Forest Officer]</p>
                                <h3 id="heading1"> NAME OF ACCUSED</h3>
                                                ...
                                                <div class="login-form">
                                                    ...
                                                    <div class="row asd d-flex">
                                                        ...
                                                        <div class="col-lg-6  col-sm-6 col-xs-6 abc">
                                                            ...
                                                            <input type="text" id="txtacnm" class="form-control console"
                                                                placeholder="">
                                                        ...
                                                        <p class="pp" style="font-weight: 700;letter-spacing: 1px;">Place Of Residence</p>
                                                        <div class="col-lg-4 col-sm-4 col-xs-4 abc">

                                                            <label class="lebl">Village</label>

                                                            <input type="text" id="txtvil" class="form-control console"
                                                                placeholder="">
                                                        </div>

                                                        <div class="col-lg-4 col-sm-4 col-xs-4 abc">

                                                            <label class="lebl">Thana</label>

                                                            <input type="text" id="txthana" class="form-control console"
                                                                placeholder="">
                                                        </div>
                                                        <div class="col-lg-4 col-sm-4 col-xs-4 abc">

                                                            <label class="lebl">District</label>

                                                            <input type="text" id="txtdist" class="form-control console"
                                                                placeholder="">
                                                        </div>
                            ...
                            <p id="heading1">FULL REPORT OF ALL THE FACTS IN DETAIL</p>
                            <h3 id="heading">FOREST DEPARTMENT, ORISSA</h3>
 ...
 <div class="col-lg-4  col-sm-4 col-xs-4 abc">		
              <label class="lebl">Offence Report No  </label>
      <input type="text" id="txtofrpt"  class="form-control console" placeholder="">	
	</div>

	 <div class="col-lg-4  col-sm-4 col-xs-4 abc">		
              <label class="lebl"> Dated   </label>
              <input type="date" id="txtdted"  class="form-control console" placeholder="">	
		</div>
	</div>
   ...
   <div class="col-lg-4  col-sm-4 col-xs-4 abc">		
    <label class="lebl">Revenue Station Range </label>
    <input type="text" id="txtrvnrng"  class="form-control console" placeholder="">	
 </div>
 <div class="col-lg-4  col-sm-4 col-xs-4 abc">		
              <label class="lebl">Memo No  </label>
      <input type="text" id="txtmemo"  class="form-control console" placeholder="">	
	</div>

	 <div class="col-lg-4  col-sm-4 col-xs-4 abc">		
              <label class="lebl">Dated </label>
              <input type="date" id="txtdated"  class="form-control console" placeholder="">	
		</div>
	</div>
												...
												<!--
                                        <p class="to36"><input type="text" id="txtdvsn" class="inp"
                                            placeholder=""> Division</p>
                                            <p class="to36"> Offence Report No <input type="number" id="txtofrpt" class="inp"
                                                placeholder=""> dated <input type="date" id="txtdted" class="inp"
                                                placeholder=""></p>
                                                <p class="to36"> <input type="text" id="txtrvnrng" class="inp"
                                                    placeholder="">Revenue Station Range</p>
                                                    <p class="to36">Memo No <input type="number" id="txtmemo" class="inp"
                                                        placeholder=""> Dated<input type="date" id="txtdated" class="inp"
                                                        placeholder=""></p>
                                                             -->
                                                            <p style="color: #000; font-size: 17px;" class="text-center"> Forwarded to the Magistrate with a request for issue of process against the
                                        accused and taking further action according to law.</p>
                                        ...
                                        <div class="row mt-2 mb-3">
                                            ...
                                            <div class="col-lg-6  col-sm-6 col-xs-6 ">
                                                ...
                                                <label class="lebl"> Divisional Forest Officer-In-Charge</label>
                                                <input type="text" id="txtdfchrg" class="form-control console">
                                                </div>
                                           ...
                                           <div class="row mt-2 mb-3">
                                            ...
                                            <div class="col-lg-6  col-sm-6 col-xs-6 ">
                                                ...
                                                <label class="lebl">Division</label>
                                                <input type="text" id="txtdvnm" class="form-control console">
                                                </div>
                                        ...
                                        <!--
                                        <div  class="mar">
                                         <p  class="to36"> Divisional Forest Officer-in-charge</p>
                                            <p  class="to36"> <input type="text" id="txtdfchrg" class="inp"
                                            placeholder=""></p>
											<p class="to36">Division</p>
											<p class="to36"><input type="text" id="txtdvnm" class="inp"placeholder=""></p>
                                            </div>
                                            -->
                                            ...
                                            <!--
                                            <p class="to36" >Memo No <input type="number" id="txtmem" class="inp"
                                                placeholder=""></p>

                                                <p class="to36" >Dated <input type="date" id="txtd" class="inp"
                                        placeholder=""></p>
                                        ...
                                        <div class="row mt-2 mb-3">
                                            ...
                                            <div class="col-lg-6  col-sm-6 col-xs-6 ">
                                                ...
                                                <label class="lebl">Memo No</label>
                                                <input type="number" id="txtmem" class="form-control console">
                                                </div>
                                            <div class="col-lg-6  col-sm-6 col-xs-6 " style="display:hidden;">
                                           </div>
                                          ...
                                          <div class="row mt-2 mb-5">
                                            ...
                                            <div class="col-lg-6  col-sm-6 col-xs-6 ">
                                                ...
                                                <label class="lebl">Dated</label>
                                                <input type="date" id="txtd" class="form-control console">
                                                </div>
                                            <div class="col-lg-6  col-sm-6 col-xs-6 " style="display:hidden;">
                                           </div>
                                        ...
                                        <p style="color: #000; font-size: 17px;" class="text-center">Forwarded to the Conservator of Forest Circle, with a copy of the Seizure Report for
                                            information. </p>
                                        ...
                                        <p  class="to36"> Divisional Forest Officer-in-charge</p>
                                            <p  class="to36"> <input type="text" id="txtdfchrgx" class="inp"
                                            placeholder=""></p>
											<p class="to36">Division</p>
											<p class="to36"><input type="text" id="txtdvnmx" class="inp"placeholder=""></p>
                                        </div>
                                        -->
                        ...
                        <div class="login-form">
                          ...
                          <div class="row asd d-flex">
                           ...
                           <div class="col-lg-6  col-sm-6 col-xs-4 abc">
                                ...
                                <button class="btny" type="button" onclick="window.location.href='finalpdf.aspx'">Download Pdf</button>
