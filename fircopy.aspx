<%@ Page Language="C#" AutoEventWireup="true" CodeFile="fircopy.aspx.cs" Inherits="fircopy" %>
        ...
        function print() {
          ...
          //  doc.addImage(imgData, 'PNG', logoX, margin, logoWidth, logoHeight); // Position and size of the logo
           ...
           // doc.text('Phone: (123) 456-7890', pageWidth / 2, margin + 95, { align: 'center' });
            ...
            doc.save('case-document-fircopy.pdf');
...
<h2 class="text-center" style="color: #fff;">FIR COPY</h2>
