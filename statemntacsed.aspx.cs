...
public partial class statemntacsed : System.Web.UI.Page
{
    ...
    public static string Insert(List<stmntaccData> jsonDynmxcxx)
    {
    ...
    public static List<stmntaccData> GetAutoCompleteData(string prefix)
    {
        List<stmntaccData> services = new List<stmntaccData>();
